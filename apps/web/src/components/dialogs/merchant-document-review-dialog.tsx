...
type DocumentType = "businessDocument";

interface MerchantDocumentReviewDialogProps {
	isOpen: boolean;
...
export const MerchantDocumentReviewDialog = ({
	isOpen,
	onOpenChange,
	merchantId,
	document,
	...
	currentStatus,
	currentReason,
}: MerchantDocumentReviewDialogProps) => {
	...
	const updateDocumentMutation = useMutation({
		mutationFn: async ({
			...
			const result = await orpcClient.merchant.updateDocumentStatus({
