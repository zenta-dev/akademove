...
class SharedQuickMessageCubit
    extends BaseCubit<OperationResult<List<QuickMessageTemplate>>> {
  SharedQuickMessageCubit({
    required QuickMessageRepository quickMessageRepository,
  ...
  Future<void> fetchTemplates({
    ...
    () async {
      try {
        ...
        logger.e(
          '[SharedQuickMessageCubit] - Error fetching templates: ${e.message}',
          error: e,
          stackTrace: st,
        );
