...
class _MerchantEditProfileScreenState extends State<MerchantEditProfileScreen> {
  ...
  // Common label style for this screen
  TextStyle get _labelStyle => context.typography.p.copyWith(
    fontSize: 16.sp,
    fontWeight: FontWeight.w500,
  );

  TextStyle get _placeholderStyle => context.typography.small.copyWith(
    fontSize: 14.sp,
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Text(context.l10n.label_outlet_location, style: _labelStyle),
        ...
        _buildMapView(),
        if (_outletAddress.isNotEmpty) _buildAddressDisplay(),
        Gap(8.h),
        _buildBenchmarkField(),
      ],
    );
  }
                      ...
                      InputFeature.leading(
                        _isSearching
                            ? SizedBox(
                                width: 16.w,
                                height: 16.h,
                                child: Icon(LucideIcons.loader, size: 16.sp),
                              )
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        separatorBuilder: (context, index) =>
            Container(height: 1, color: context.theme.colorScheme.border),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          displayText,
                          style: _placeholderStyle.copyWith(
                            overflow: TextOverflow.ellipsis,
                          ),
                          maxLines: 1,
                        ),
                        if (suggestion.country case final country?)
                          Text(
                            country,
            ...
            : Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(context.l10n.loading, style: context.typography.small),
                  ],
                ),
              ),
      ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(child: Text(_outletAddress, style: _placeholderStyle)),
        ],
      ),
    );
  }

  Widget _buildBenchmarkField() {
    return FormField(
      key: _FormKeys.outletBenchmark,
      label: Text(context.l10n.label_benchmark_optional, style: _labelStyle),
      child: TextField(
        placeholder: Text(
          ...
          Row(
            children: [
              ...
              Text(
                ...
                style: _labelStyle.copyWith(fontSize: 14.sp),
              ),
            ],
          ),
          Container(
            height: 1,
            color: context.theme.colorScheme.border.withValues(alpha: 0.3),
          ),
          _buildBankDetailRow(
  ...
  Widget _buildBankDetailRow(String label, String value) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Expanded(flex: 2, child: Text(label, style: _placeholderStyle)),
        Text(":", style: _placeholderStyle),
        Gap(8.w),
        Expanded(flex: 2, child: Text(value, style: _placeholderStyle)),
      ],
    );
  }
