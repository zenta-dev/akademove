...
class _RideStatusIndicator extends StatelessWidget {
  const _RideStatusIndicator({required this.status});
  ...
  Widget build(BuildContext context) {
    ...
    int currentStep = _getCurrentStep(status, steps);
  ...
  int _getCurrentStep(OrderStatus? status, List<(String, OrderStatus)> steps) {
