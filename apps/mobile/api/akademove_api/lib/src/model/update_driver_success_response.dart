...
/// * [data]
@BuiltValue()
abstract class UpdateDriverSuccessResponse
    implements
        Built<UpdateDriverSuccessResponse, UpdateDriverSuccessResponseBuilder> {
  ...
  factory UpdateDriverSuccessResponse(
          [void updates(UpdateDriverSuccessResponseBuilder b)]) =
      _$UpdateDriverSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateDriverSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateDriverSuccessResponse> get serializer =>
      _$UpdateDriverSuccessResponseSerializer();
}

class _$UpdateDriverSuccessResponseSerializer
    implements PrimitiveSerializer<UpdateDriverSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(UpdateDriverSuccessResponseSuccessEnum),
...
class UpdateDriverSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const UpdateDriverSuccessResponseSuccessEnum true_ =
      _$updateDriverSuccessResponseSuccessEnum_true_;

  static Serializer<UpdateDriverSuccessResponseSuccessEnum> get serializer =>
      _$updateDriverSuccessResponseSuccessEnumSerializer;

  const UpdateDriverSuccessResponseSuccessEnum._(String name) : super(name);

  static BuiltSet<UpdateDriverSuccessResponseSuccessEnum> get values =>
      _$updateDriverSuccessResponseSuccessEnumValues;
  static UpdateDriverSuccessResponseSuccessEnum valueOf(String name) =>
      _$updateDriverSuccessResponseSuccessEnumValueOf(name);
}
