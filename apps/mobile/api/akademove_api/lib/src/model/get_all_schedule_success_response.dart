...
/// * [data]
@BuiltValue()
abstract class GetAllScheduleSuccessResponse
    implements
        Built<GetAllScheduleSuccessResponse,
  ...
  factory GetAllScheduleSuccessResponse(
          [void updates(GetAllScheduleSuccessResponseBuilder b)]) =
      _$GetAllScheduleSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GetAllScheduleSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetAllScheduleSuccessResponse> get serializer =>
      _$GetAllScheduleSuccessResponseSerializer();
}

class _$GetAllScheduleSuccessResponseSerializer
    implements PrimitiveSerializer<GetAllScheduleSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(GetAllScheduleSuccessResponseSuccessEnum),
...
class GetAllScheduleSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const GetAllScheduleSuccessResponseSuccessEnum true_ =
      _$getAllScheduleSuccessResponseSuccessEnum_true_;

  static Serializer<GetAllScheduleSuccessResponseSuccessEnum> get serializer =>
  ...
  static BuiltSet<GetAllScheduleSuccessResponseSuccessEnum> get values =>
      _$getAllScheduleSuccessResponseSuccessEnumValues;
  static GetAllScheduleSuccessResponseSuccessEnum valueOf(String name) =>
      _$getAllScheduleSuccessResponseSuccessEnumValueOf(name);
}
