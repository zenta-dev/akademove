...
abstract class Driver implements Built<Driver, DriverBuilder> {
  ...
  static void _defaults(DriverBuilder b) => b..isOnline = false;
...
class _$DriverSerializer implements PrimitiveSerializer<Driver> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield object.currentLocation == null
        ? null
    ...
    yield object.lastLocationUpdate == null
        ? null
        : serializers.serialize(
...
class DriverStatusEnum extends EnumClass {
  ...
  static Serializer<DriverStatusEnum> get serializer =>
  ...
  static DriverStatusEnum valueOf(String name) =>
      _$driverStatusEnumValueOf(name);
}
