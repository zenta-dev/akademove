...
final BuiltSet<GetDriverByIdSuccessResponseSuccessEnum>
    _$getDriverByIdSuccessResponseSuccessEnumValues = BuiltSet<
        GetDriverByIdSuccessResponseSuccessEnum>(const <GetDriverByIdSuccessResponseSuccessEnum>[
  _$getDriverByIdSuccessResponseSuccessEnum_true_,
]);
...
class GetDriverByIdSuccessResponseBuilder
    implements
        Builder<GetDriverByIdSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$GetDriverByIdSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'GetDriverByIdSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'GetDriverByIdSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GetDriverByIdSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
