...
/// * [data]
@BuiltValue()
abstract class CreateOrderSuccessResponse
    implements
        Built<CreateOrderSuccessResponse, CreateOrderSuccessResponseBuilder> {
  ...
  factory CreateOrderSuccessResponse(
          [void updates(CreateOrderSuccessResponseBuilder b)]) =
      _$CreateOrderSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateOrderSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateOrderSuccessResponse> get serializer =>
      _$CreateOrderSuccessResponseSerializer();
}

class _$CreateOrderSuccessResponseSerializer
    implements PrimitiveSerializer<CreateOrderSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(CreateOrderSuccessResponseSuccessEnum),
...
class CreateOrderSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const CreateOrderSuccessResponseSuccessEnum true_ =
      _$createOrderSuccessResponseSuccessEnum_true_;

  static Serializer<CreateOrderSuccessResponseSuccessEnum> get serializer =>
      _$createOrderSuccessResponseSuccessEnumSerializer;

  const CreateOrderSuccessResponseSuccessEnum._(String name) : super(name);

  static BuiltSet<CreateOrderSuccessResponseSuccessEnum> get values =>
      _$createOrderSuccessResponseSuccessEnumValues;
  static CreateOrderSuccessResponseSuccessEnum valueOf(String name) =>
      _$createOrderSuccessResponseSuccessEnumValueOf(name);
}
