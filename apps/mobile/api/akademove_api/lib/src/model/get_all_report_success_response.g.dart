...
final BuiltSet<GetAllReportSuccessResponseSuccessEnum>
    _$getAllReportSuccessResponseSuccessEnumValues = BuiltSet<
        GetAllReportSuccessResponseSuccessEnum>(const <GetAllReportSuccessResponseSuccessEnum>[
  _$getAllReportSuccessResponseSuccessEnum_true_,
]);
...
class GetAllReportSuccessResponseBuilder
    implements
        Builder<GetAllReportSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$GetAllReportSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'GetAllReportSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'GetAllReportSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GetAllReportSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
