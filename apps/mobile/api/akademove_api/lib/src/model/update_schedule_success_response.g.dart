...
final BuiltSet<UpdateScheduleSuccessResponseSuccessEnum>
    _$updateScheduleSuccessResponseSuccessEnumValues = BuiltSet<
        UpdateScheduleSuccessResponseSuccessEnum>(const <UpdateScheduleSuccessResponseSuccessEnum>[
  _$updateScheduleSuccessResponseSuccessEnum_true_,
]);
...
class UpdateScheduleSuccessResponseBuilder
    implements
        Builder<UpdateScheduleSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$UpdateScheduleSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'UpdateScheduleSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'UpdateScheduleSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'UpdateScheduleSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
