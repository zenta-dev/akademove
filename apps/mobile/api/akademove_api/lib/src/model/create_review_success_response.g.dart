...
final BuiltSet<CreateReviewSuccessResponseSuccessEnum>
    _$createReviewSuccessResponseSuccessEnumValues = BuiltSet<
        CreateReviewSuccessResponseSuccessEnum>(const <CreateReviewSuccessResponseSuccessEnum>[
  _$createReviewSuccessResponseSuccessEnum_true_,
]);
...
class CreateReviewSuccessResponseBuilder
    implements
        Builder<CreateReviewSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$CreateReviewSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'CreateReviewSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'CreateReviewSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'CreateReviewSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
