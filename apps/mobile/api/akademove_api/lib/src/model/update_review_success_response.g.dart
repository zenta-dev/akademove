...
final BuiltSet<UpdateReviewSuccessResponseSuccessEnum>
    _$updateReviewSuccessResponseSuccessEnumValues = BuiltSet<
        UpdateReviewSuccessResponseSuccessEnum>(const <UpdateReviewSuccessResponseSuccessEnum>[
  _$updateReviewSuccessResponseSuccessEnum_true_,
]);
...
class UpdateReviewSuccessResponseBuilder
    implements
        Builder<UpdateReviewSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$UpdateReviewSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'UpdateReviewSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'UpdateReviewSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'UpdateReviewSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
