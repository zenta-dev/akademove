...
final BuiltSet<GetAllDriverSuccessResponseSuccessEnum>
    _$getAllDriverSuccessResponseSuccessEnumValues = BuiltSet<
        GetAllDriverSuccessResponseSuccessEnum>(const <GetAllDriverSuccessResponseSuccessEnum>[
  _$getAllDriverSuccessResponseSuccessEnum_true_,
]);
...
class GetAllDriverSuccessResponseBuilder
    implements
        Builder<GetAllDriverSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$GetAllDriverSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'GetAllDriverSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'GetAllDriverSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GetAllDriverSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
