...
/// * [data]
@BuiltValue()
abstract class GetReportByIdSuccessResponse
    implements
        Built<GetReportByIdSuccessResponse,
  ...
  factory GetReportByIdSuccessResponse(
          [void updates(GetReportByIdSuccessResponseBuilder b)]) =
      _$GetReportByIdSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GetReportByIdSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetReportByIdSuccessResponse> get serializer =>
      _$GetReportByIdSuccessResponseSerializer();
}

class _$GetReportByIdSuccessResponseSerializer
    implements PrimitiveSerializer<GetReportByIdSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(GetReportByIdSuccessResponseSuccessEnum),
...
class GetReportByIdSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const GetReportByIdSuccessResponseSuccessEnum true_ =
      _$getReportByIdSuccessResponseSuccessEnum_true_;

  static Serializer<GetReportByIdSuccessResponseSuccessEnum> get serializer =>
  ...
  static BuiltSet<GetReportByIdSuccessResponseSuccessEnum> get values =>
      _$getReportByIdSuccessResponseSuccessEnumValues;
  static GetReportByIdSuccessResponseSuccessEnum valueOf(String name) =>
      _$getReportByIdSuccessResponseSuccessEnumValueOf(name);
}
