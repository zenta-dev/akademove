...
final BuiltSet<DeleteMerchantSuccessResponseSuccessEnum>
    _$deleteMerchantSuccessResponseSuccessEnumValues = BuiltSet<
        DeleteMerchantSuccessResponseSuccessEnum>(const <DeleteMerchantSuccessResponseSuccessEnum>[
  _$deleteMerchantSuccessResponseSuccessEnum_true_,
]);
...
class DeleteMerchantSuccessResponseBuilder
    implements
        Builder<DeleteMerchantSuccessResponse,
    ...
    final _$result = _$v ??
        _$DeleteMerchantSuccessResponse._(
          success: BuiltValueNullFieldError.checkNotNull(
              success, r'DeleteMerchantSuccessResponse', 'success'),
          message: BuiltValueNullFieldError.checkNotNull(
              message, r'DeleteMerchantSuccessResponse', 'message'),
          data: data,
        );
    replace(_$result);
    return _$result;
