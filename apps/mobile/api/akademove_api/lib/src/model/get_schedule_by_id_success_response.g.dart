...
final BuiltSet<GetScheduleByIdSuccessResponseSuccessEnum>
    _$getScheduleByIdSuccessResponseSuccessEnumValues = BuiltSet<
        GetScheduleByIdSuccessResponseSuccessEnum>(const <GetScheduleByIdSuccessResponseSuccessEnum>[
  _$getScheduleByIdSuccessResponseSuccessEnum_true_,
]);
...
class GetScheduleByIdSuccessResponseBuilder
    implements
        Builder<GetScheduleByIdSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$GetScheduleByIdSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'GetScheduleByIdSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'GetScheduleByIdSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GetScheduleByIdSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
