...
/// * [data]
@BuiltValue()
abstract class UpdateScheduleSuccessResponse
    implements
        Built<UpdateScheduleSuccessResponse,
  ...
  factory UpdateScheduleSuccessResponse(
          [void updates(UpdateScheduleSuccessResponseBuilder b)]) =
      _$UpdateScheduleSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateScheduleSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateScheduleSuccessResponse> get serializer =>
      _$UpdateScheduleSuccessResponseSerializer();
}

class _$UpdateScheduleSuccessResponseSerializer
    implements PrimitiveSerializer<UpdateScheduleSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(UpdateScheduleSuccessResponseSuccessEnum),
...
class UpdateScheduleSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const UpdateScheduleSuccessResponseSuccessEnum true_ =
      _$updateScheduleSuccessResponseSuccessEnum_true_;

  static Serializer<UpdateScheduleSuccessResponseSuccessEnum> get serializer =>
  ...
  static BuiltSet<UpdateScheduleSuccessResponseSuccessEnum> get values =>
      _$updateScheduleSuccessResponseSuccessEnumValues;
  static UpdateScheduleSuccessResponseSuccessEnum valueOf(String name) =>
      _$updateScheduleSuccessResponseSuccessEnumValueOf(name);
}
