...
abstract class Report implements Built<Report, ReportBuilder> {
  ...
  static void _defaults(ReportBuilder b) =>
      b..status = const ReportStatusEnum._('pending');
...
class ReportCategoryEnum extends EnumClass {
  ...
  static ReportCategoryEnum valueOf(String name) =>
      _$reportCategoryEnumValueOf(name);
}
...
class ReportStatusEnum extends EnumClass {
  ...
  static const ReportStatusEnum investigating =
  ...
  static Serializer<ReportStatusEnum> get serializer =>
  ...
  static ReportStatusEnum valueOf(String name) =>
      _$reportStatusEnumValueOf(name);
}
