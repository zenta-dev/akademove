...
/// * [data]
@BuiltValue()
abstract class GetAllPromoSuccessResponse
    implements
        Built<GetAllPromoSuccessResponse, GetAllPromoSuccessResponseBuilder> {
  ...
  factory GetAllPromoSuccessResponse(
          [void updates(GetAllPromoSuccessResponseBuilder b)]) =
      _$GetAllPromoSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GetAllPromoSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetAllPromoSuccessResponse> get serializer =>
      _$GetAllPromoSuccessResponseSerializer();
}

class _$GetAllPromoSuccessResponseSerializer
    implements PrimitiveSerializer<GetAllPromoSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(GetAllPromoSuccessResponseSuccessEnum),
...
class GetAllPromoSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const GetAllPromoSuccessResponseSuccessEnum true_ =
      _$getAllPromoSuccessResponseSuccessEnum_true_;

  static Serializer<GetAllPromoSuccessResponseSuccessEnum> get serializer =>
      _$getAllPromoSuccessResponseSuccessEnumSerializer;

  const GetAllPromoSuccessResponseSuccessEnum._(String name) : super(name);

  static BuiltSet<GetAllPromoSuccessResponseSuccessEnum> get values =>
      _$getAllPromoSuccessResponseSuccessEnumValues;
  static GetAllPromoSuccessResponseSuccessEnum valueOf(String name) =>
      _$getAllPromoSuccessResponseSuccessEnumValueOf(name);
}
