...
const OrderTypeEnum _$orderTypeEnum_delivery =
    const OrderTypeEnum._('delivery');
...
const OrderStatusEnum _$orderStatusEnum_requested =
    const OrderStatusEnum._('requested');
const OrderStatusEnum _$orderStatusEnum_matching =
    const OrderStatusEnum._('matching');
const OrderStatusEnum _$orderStatusEnum_accepted =
    const OrderStatusEnum._('accepted');
const OrderStatusEnum _$orderStatusEnum_arriving =
    const OrderStatusEnum._('arriving');
const OrderStatusEnum _$orderStatusEnum_inTrip =
    const OrderStatusEnum._('inTrip');
      ...
      _$result = _$v ??
          _$Order._(
            ...
            requestedAt: BuiltValueNullFieldError.checkNotNull(
                requestedAt, r'Order', 'requestedAt'),
