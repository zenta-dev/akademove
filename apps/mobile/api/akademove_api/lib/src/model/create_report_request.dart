...
abstract class CreateReportRequest
  ...
  static void _defaults(CreateReportRequestBuilder b) =>
      b..status = const CreateReportRequestStatusEnum._('pending');
...
class CreateReportRequestCategoryEnum extends EnumClass {
  ...
  static const CreateReportRequestCategoryEnum behavior =
      _$createReportRequestCategoryEnum_behavior;
  @BuiltValueEnumConst(wireName: r'safety')
  static const CreateReportRequestCategoryEnum safety =
      _$createReportRequestCategoryEnum_safety;
  @BuiltValueEnumConst(wireName: r'fraud')
  static const CreateReportRequestCategoryEnum fraud =
      _$createReportRequestCategoryEnum_fraud;
  @BuiltValueEnumConst(wireName: r'other')
  static const CreateReportRequestCategoryEnum other =
      _$createReportRequestCategoryEnum_other;

  static Serializer<CreateReportRequestCategoryEnum> get serializer =>
      _$createReportRequestCategoryEnumSerializer;

  const CreateReportRequestCategoryEnum._(String name) : super(name);

  static BuiltSet<CreateReportRequestCategoryEnum> get values =>
      _$createReportRequestCategoryEnumValues;
  static CreateReportRequestCategoryEnum valueOf(String name) =>
      _$createReportRequestCategoryEnumValueOf(name);
}

class CreateReportRequestStatusEnum extends EnumClass {
  @BuiltValueEnumConst(wireName: r'pending')
  static const CreateReportRequestStatusEnum pending =
      _$createReportRequestStatusEnum_pending;
  @BuiltValueEnumConst(wireName: r'investigating')
  static const CreateReportRequestStatusEnum investigating =
      _$createReportRequestStatusEnum_investigating;
  @BuiltValueEnumConst(wireName: r'resolved')
  static const CreateReportRequestStatusEnum resolved =
      _$createReportRequestStatusEnum_resolved;
  @BuiltValueEnumConst(wireName: r'dismissed')
  static const CreateReportRequestStatusEnum dismissed =
      _$createReportRequestStatusEnum_dismissed;

  static Serializer<CreateReportRequestStatusEnum> get serializer =>
      _$createReportRequestStatusEnumSerializer;

  const CreateReportRequestStatusEnum._(String name) : super(name);

  static BuiltSet<CreateReportRequestStatusEnum> get values =>
      _$createReportRequestStatusEnumValues;
  static CreateReportRequestStatusEnum valueOf(String name) =>
      _$createReportRequestStatusEnumValueOf(name);
}
