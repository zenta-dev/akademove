...
final BuiltSet<GetAllPromoSuccessResponseSuccessEnum>
    _$getAllPromoSuccessResponseSuccessEnumValues = BuiltSet<
        GetAllPromoSuccessResponseSuccessEnum>(const <GetAllPromoSuccessResponseSuccessEnum>[
  _$getAllPromoSuccessResponseSuccessEnum_true_,
]);
...
class _$GetAllPromoSuccessResponseSuccessEnumSerializer
  ...
  @override
  Object serialize(
          Serializers serializers, GetAllPromoSuccessResponseSuccessEnum object,
    ...
    try {
      _$result = _$v ??
          _$GetAllPromoSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'GetAllPromoSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'GetAllPromoSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GetAllPromoSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
