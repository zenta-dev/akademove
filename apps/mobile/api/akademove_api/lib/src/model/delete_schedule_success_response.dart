...
/// * [data]
@BuiltValue()
abstract class DeleteScheduleSuccessResponse
    implements
        Built<DeleteScheduleSuccessResponse,
  ...
  factory DeleteScheduleSuccessResponse(
          [void updates(DeleteScheduleSuccessResponseBuilder b)]) =
      _$DeleteScheduleSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DeleteScheduleSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DeleteScheduleSuccessResponse> get serializer =>
      _$DeleteScheduleSuccessResponseSerializer();
}

class _$DeleteScheduleSuccessResponseSerializer
    implements PrimitiveSerializer<DeleteScheduleSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(DeleteScheduleSuccessResponseSuccessEnum),
...
class DeleteScheduleSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const DeleteScheduleSuccessResponseSuccessEnum true_ =
      _$deleteScheduleSuccessResponseSuccessEnum_true_;

  static Serializer<DeleteScheduleSuccessResponseSuccessEnum> get serializer =>
  ...
  static BuiltSet<DeleteScheduleSuccessResponseSuccessEnum> get values =>
      _$deleteScheduleSuccessResponseSuccessEnumValues;
  static DeleteScheduleSuccessResponseSuccessEnum valueOf(String name) =>
      _$deleteScheduleSuccessResponseSuccessEnumValueOf(name);
}
