...
final BuiltSet<GetReportByIdSuccessResponseSuccessEnum>
    _$getReportByIdSuccessResponseSuccessEnumValues = BuiltSet<
        GetReportByIdSuccessResponseSuccessEnum>(const <GetReportByIdSuccessResponseSuccessEnum>[
  _$getReportByIdSuccessResponseSuccessEnum_true_,
]);
...
class GetReportByIdSuccessResponseBuilder
    implements
        Builder<GetReportByIdSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$GetReportByIdSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'GetReportByIdSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'GetReportByIdSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GetReportByIdSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
