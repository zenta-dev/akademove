...
final BuiltSet<GetOrderByIdSuccessResponseSuccessEnum>
    _$getOrderByIdSuccessResponseSuccessEnumValues = BuiltSet<
        GetOrderByIdSuccessResponseSuccessEnum>(const <GetOrderByIdSuccessResponseSuccessEnum>[
  _$getOrderByIdSuccessResponseSuccessEnum_true_,
]);
...
class GetOrderByIdSuccessResponseBuilder
    implements
        Builder<GetOrderByIdSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$GetOrderByIdSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'GetOrderByIdSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'GetOrderByIdSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GetOrderByIdSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
