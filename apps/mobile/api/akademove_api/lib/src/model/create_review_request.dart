...
class CreateReviewRequestCategoryEnum extends EnumClass {
  ...
  static const CreateReviewRequestCategoryEnum cleanliness =
      _$createReviewRequestCategoryEnum_cleanliness;
  @BuiltValueEnumConst(wireName: r'courtesy')
  static const CreateReviewRequestCategoryEnum courtesy =
      _$createReviewRequestCategoryEnum_courtesy;
  @BuiltValueEnumConst(wireName: r'other')
  static const CreateReviewRequestCategoryEnum other =
      _$createReviewRequestCategoryEnum_other;

  static Serializer<CreateReviewRequestCategoryEnum> get serializer =>
      _$createReviewRequestCategoryEnumSerializer;

  const CreateReviewRequestCategoryEnum._(String name) : super(name);

  static BuiltSet<CreateReviewRequestCategoryEnum> get values =>
      _$createReviewRequestCategoryEnumValues;
  static CreateReviewRequestCategoryEnum valueOf(String name) =>
      _$createReviewRequestCategoryEnumValueOf(name);
}
