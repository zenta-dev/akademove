...
/// * [data]
@BuiltValue()
abstract class GetScheduleByIdSuccessResponse
    implements
        Built<GetScheduleByIdSuccessResponse,
  ...
  factory GetScheduleByIdSuccessResponse(
          [void updates(GetScheduleByIdSuccessResponseBuilder b)]) =
      _$GetScheduleByIdSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GetScheduleByIdSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetScheduleByIdSuccessResponse> get serializer =>
      _$GetScheduleByIdSuccessResponseSerializer();
}

class _$GetScheduleByIdSuccessResponseSerializer
    implements PrimitiveSerializer<GetScheduleByIdSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(GetScheduleByIdSuccessResponseSuccessEnum),
...
class GetScheduleByIdSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const GetScheduleByIdSuccessResponseSuccessEnum true_ =
      _$getScheduleByIdSuccessResponseSuccessEnum_true_;

  static Serializer<GetScheduleByIdSuccessResponseSuccessEnum> get serializer =>
  ...
  static BuiltSet<GetScheduleByIdSuccessResponseSuccessEnum> get values =>
      _$getScheduleByIdSuccessResponseSuccessEnumValues;
  static GetScheduleByIdSuccessResponseSuccessEnum valueOf(String name) =>
      _$getScheduleByIdSuccessResponseSuccessEnumValueOf(name);
}
