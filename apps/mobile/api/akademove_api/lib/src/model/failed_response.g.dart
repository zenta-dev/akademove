...
class _$FailedResponseSuccessEnumSerializer
  ...
  @override
  Object serialize(Serializers serializers, FailedResponseSuccessEnum object,
    ...
    try {
      _$result = _$v ??
          _$FailedResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'FailedResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'FailedResponse', 'message'),
            errors: errors.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'FailedResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
