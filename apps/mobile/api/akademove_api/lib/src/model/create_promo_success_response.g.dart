...
final BuiltSet<CreatePromoSuccessResponseSuccessEnum>
    _$createPromoSuccessResponseSuccessEnumValues = BuiltSet<
        CreatePromoSuccessResponseSuccessEnum>(const <CreatePromoSuccessResponseSuccessEnum>[
  _$createPromoSuccessResponseSuccessEnum_true_,
]);
...
class _$CreatePromoSuccessResponseSuccessEnumSerializer
  ...
  @override
  Object serialize(
          Serializers serializers, CreatePromoSuccessResponseSuccessEnum object,
    ...
    try {
      _$result = _$v ??
          _$CreatePromoSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'CreatePromoSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'CreatePromoSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'CreatePromoSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
