...
final BuiltSet<GetAllScheduleSuccessResponseSuccessEnum>
    _$getAllScheduleSuccessResponseSuccessEnumValues = BuiltSet<
        GetAllScheduleSuccessResponseSuccessEnum>(const <GetAllScheduleSuccessResponseSuccessEnum>[
  _$getAllScheduleSuccessResponseSuccessEnum_true_,
]);
...
class GetAllScheduleSuccessResponseBuilder
    implements
        Builder<GetAllScheduleSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$GetAllScheduleSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'GetAllScheduleSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'GetAllScheduleSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GetAllScheduleSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
