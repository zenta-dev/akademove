...
/// * [data]
@BuiltValue()
abstract class DeleteMerchantSuccessResponse
    implements
        Built<DeleteMerchantSuccessResponse,
  ...
  factory DeleteMerchantSuccessResponse(
          [void updates(DeleteMerchantSuccessResponseBuilder b)]) =
      _$DeleteMerchantSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DeleteMerchantSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DeleteMerchantSuccessResponse> get serializer =>
      _$DeleteMerchantSuccessResponseSerializer();
}

class _$DeleteMerchantSuccessResponseSerializer
    implements PrimitiveSerializer<DeleteMerchantSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(DeleteMerchantSuccessResponseSuccessEnum),
...
class DeleteMerchantSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const DeleteMerchantSuccessResponseSuccessEnum true_ =
      _$deleteMerchantSuccessResponseSuccessEnum_true_;

  static Serializer<DeleteMerchantSuccessResponseSuccessEnum> get serializer =>
  ...
  static BuiltSet<DeleteMerchantSuccessResponseSuccessEnum> get values =>
      _$deleteMerchantSuccessResponseSuccessEnumValues;
  static DeleteMerchantSuccessResponseSuccessEnum valueOf(String name) =>
      _$deleteMerchantSuccessResponseSuccessEnumValueOf(name);
}
