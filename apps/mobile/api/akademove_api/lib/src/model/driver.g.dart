...
const DriverStatusEnum _$driverStatusEnum_pending =
    const DriverStatusEnum._('pending');
const DriverStatusEnum _$driverStatusEnum_approved =
    const DriverStatusEnum._('approved');
const DriverStatusEnum _$driverStatusEnum_rejected =
    const DriverStatusEnum._('rejected');
const DriverStatusEnum _$driverStatusEnum_active =
    const DriverStatusEnum._('active');
const DriverStatusEnum _$driverStatusEnum_inactive =
    const DriverStatusEnum._('inactive');
const DriverStatusEnum _$driverStatusEnum_suspended =
    const DriverStatusEnum._('suspended');
...
class _$DriverStatusEnumSerializer
  ...
  @override
  Object serialize(Serializers serializers, DriverStatusEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  DriverStatusEnum deserialize(Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
