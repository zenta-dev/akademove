...
/// * [data]
@BuiltValue()
abstract class CreatePromoSuccessResponse
    implements
        Built<CreatePromoSuccessResponse, CreatePromoSuccessResponseBuilder> {
  ...
  factory CreatePromoSuccessResponse(
          [void updates(CreatePromoSuccessResponseBuilder b)]) =
      _$CreatePromoSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreatePromoSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreatePromoSuccessResponse> get serializer =>
      _$CreatePromoSuccessResponseSerializer();
}

class _$CreatePromoSuccessResponseSerializer
    implements PrimitiveSerializer<CreatePromoSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(CreatePromoSuccessResponseSuccessEnum),
...
class CreatePromoSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const CreatePromoSuccessResponseSuccessEnum true_ =
      _$createPromoSuccessResponseSuccessEnum_true_;

  static Serializer<CreatePromoSuccessResponseSuccessEnum> get serializer =>
      _$createPromoSuccessResponseSuccessEnumSerializer;

  const CreatePromoSuccessResponseSuccessEnum._(String name) : super(name);

  static BuiltSet<CreatePromoSuccessResponseSuccessEnum> get values =>
      _$createPromoSuccessResponseSuccessEnumValues;
  static CreatePromoSuccessResponseSuccessEnum valueOf(String name) =>
      _$createPromoSuccessResponseSuccessEnumValueOf(name);
}
