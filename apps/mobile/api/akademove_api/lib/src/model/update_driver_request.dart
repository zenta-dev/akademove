...
/// * [currentLocation]
@BuiltValue()
abstract class UpdateDriverRequest
    implements Built<UpdateDriverRequest, UpdateDriverRequestBuilder> {
  ...
  factory UpdateDriverRequest([void updates(UpdateDriverRequestBuilder b)]) =
      _$UpdateDriverRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateDriverRequestBuilder b) => b..isOnline = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateDriverRequest> get serializer =>
      _$UpdateDriverRequestSerializer();
}

class _$UpdateDriverRequestSerializer
    implements PrimitiveSerializer<UpdateDriverRequest> {
  @override
...
class UpdateDriverRequestStatusEnum extends EnumClass {
  ...
  static const UpdateDriverRequestStatusEnum pending =
      _$updateDriverRequestStatusEnum_pending;
  @BuiltValueEnumConst(wireName: r'approved')
  static const UpdateDriverRequestStatusEnum approved =
      _$updateDriverRequestStatusEnum_approved;
  @BuiltValueEnumConst(wireName: r'rejected')
  static const UpdateDriverRequestStatusEnum rejected =
      _$updateDriverRequestStatusEnum_rejected;
  @BuiltValueEnumConst(wireName: r'active')
  static const UpdateDriverRequestStatusEnum active =
      _$updateDriverRequestStatusEnum_active;
  @BuiltValueEnumConst(wireName: r'inactive')
  static const UpdateDriverRequestStatusEnum inactive =
      _$updateDriverRequestStatusEnum_inactive;
  @BuiltValueEnumConst(wireName: r'suspended')
  static const UpdateDriverRequestStatusEnum suspended =
      _$updateDriverRequestStatusEnum_suspended;

  static Serializer<UpdateDriverRequestStatusEnum> get serializer =>
      _$updateDriverRequestStatusEnumSerializer;

  const UpdateDriverRequestStatusEnum._(String name) : super(name);

  static BuiltSet<UpdateDriverRequestStatusEnum> get values =>
      _$updateDriverRequestStatusEnumValues;
  static UpdateDriverRequestStatusEnum valueOf(String name) =>
      _$updateDriverRequestStatusEnumValueOf(name);
}
