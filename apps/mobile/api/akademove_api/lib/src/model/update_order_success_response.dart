...
/// * [data]
@BuiltValue()
abstract class UpdateOrderSuccessResponse
    implements
        Built<UpdateOrderSuccessResponse, UpdateOrderSuccessResponseBuilder> {
  ...
  factory UpdateOrderSuccessResponse(
          [void updates(UpdateOrderSuccessResponseBuilder b)]) =
      _$UpdateOrderSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateOrderSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateOrderSuccessResponse> get serializer =>
      _$UpdateOrderSuccessResponseSerializer();
}

class _$UpdateOrderSuccessResponseSerializer
    implements PrimitiveSerializer<UpdateOrderSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(UpdateOrderSuccessResponseSuccessEnum),
...
class UpdateOrderSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const UpdateOrderSuccessResponseSuccessEnum true_ =
      _$updateOrderSuccessResponseSuccessEnum_true_;

  static Serializer<UpdateOrderSuccessResponseSuccessEnum> get serializer =>
      _$updateOrderSuccessResponseSuccessEnumSerializer;

  const UpdateOrderSuccessResponseSuccessEnum._(String name) : super(name);

  static BuiltSet<UpdateOrderSuccessResponseSuccessEnum> get values =>
      _$updateOrderSuccessResponseSuccessEnumValues;
  static UpdateOrderSuccessResponseSuccessEnum valueOf(String name) =>
      _$updateOrderSuccessResponseSuccessEnumValueOf(name);
}
