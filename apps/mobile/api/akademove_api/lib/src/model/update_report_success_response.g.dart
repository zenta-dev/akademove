...
final BuiltSet<UpdateReportSuccessResponseSuccessEnum>
    _$updateReportSuccessResponseSuccessEnumValues = BuiltSet<
        UpdateReportSuccessResponseSuccessEnum>(const <UpdateReportSuccessResponseSuccessEnum>[
  _$updateReportSuccessResponseSuccessEnum_true_,
]);
...
class UpdateReportSuccessResponseBuilder
    implements
        Builder<UpdateReportSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$UpdateReportSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'UpdateReportSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'UpdateReportSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'UpdateReportSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
