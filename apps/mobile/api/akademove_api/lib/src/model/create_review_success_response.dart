...
/// * [data]
@BuiltValue()
abstract class CreateReviewSuccessResponse
    implements
        Built<CreateReviewSuccessResponse, CreateReviewSuccessResponseBuilder> {
  ...
  factory CreateReviewSuccessResponse(
          [void updates(CreateReviewSuccessResponseBuilder b)]) =
      _$CreateReviewSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateReviewSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateReviewSuccessResponse> get serializer =>
      _$CreateReviewSuccessResponseSerializer();
}

class _$CreateReviewSuccessResponseSerializer
    implements PrimitiveSerializer<CreateReviewSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(CreateReviewSuccessResponseSuccessEnum),
...
class CreateReviewSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const CreateReviewSuccessResponseSuccessEnum true_ =
      _$createReviewSuccessResponseSuccessEnum_true_;

  static Serializer<CreateReviewSuccessResponseSuccessEnum> get serializer =>
      _$createReviewSuccessResponseSuccessEnumSerializer;

  const CreateReviewSuccessResponseSuccessEnum._(String name) : super(name);

  static BuiltSet<CreateReviewSuccessResponseSuccessEnum> get values =>
      _$createReviewSuccessResponseSuccessEnumValues;
  static CreateReviewSuccessResponseSuccessEnum valueOf(String name) =>
      _$createReviewSuccessResponseSuccessEnumValueOf(name);
}
