...
/// * [data]
@BuiltValue()
abstract class GetReviewByIdSuccessResponse
    implements
        Built<GetReviewByIdSuccessResponse,
  ...
  factory GetReviewByIdSuccessResponse(
          [void updates(GetReviewByIdSuccessResponseBuilder b)]) =
      _$GetReviewByIdSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GetReviewByIdSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetReviewByIdSuccessResponse> get serializer =>
      _$GetReviewByIdSuccessResponseSerializer();
}

class _$GetReviewByIdSuccessResponseSerializer
    implements PrimitiveSerializer<GetReviewByIdSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(GetReviewByIdSuccessResponseSuccessEnum),
...
class GetReviewByIdSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const GetReviewByIdSuccessResponseSuccessEnum true_ =
      _$getReviewByIdSuccessResponseSuccessEnum_true_;

  static Serializer<GetReviewByIdSuccessResponseSuccessEnum> get serializer =>
  ...
  static BuiltSet<GetReviewByIdSuccessResponseSuccessEnum> get values =>
      _$getReviewByIdSuccessResponseSuccessEnumValues;
  static GetReviewByIdSuccessResponseSuccessEnum valueOf(String name) =>
      _$getReviewByIdSuccessResponseSuccessEnumValueOf(name);
}
