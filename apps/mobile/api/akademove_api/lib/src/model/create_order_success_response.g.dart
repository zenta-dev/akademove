...
final BuiltSet<CreateOrderSuccessResponseSuccessEnum>
    _$createOrderSuccessResponseSuccessEnumValues = BuiltSet<
        CreateOrderSuccessResponseSuccessEnum>(const <CreateOrderSuccessResponseSuccessEnum>[
  _$createOrderSuccessResponseSuccessEnum_true_,
]);
...
class _$CreateOrderSuccessResponseSuccessEnumSerializer
  ...
  @override
  Object serialize(
          Serializers serializers, CreateOrderSuccessResponseSuccessEnum object,
    ...
    try {
      _$result = _$v ??
          _$CreateOrderSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'CreateOrderSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'CreateOrderSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'CreateOrderSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
