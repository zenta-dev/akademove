...
/// * [createdById]
@BuiltValue()
abstract class CreatePromoRequest
    implements Built<CreatePromoRequest, CreatePromoRequestBuilder> {
  ...
  factory CreatePromoRequest([void updates(CreatePromoRequestBuilder b)]) =
      _$CreatePromoRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreatePromoRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreatePromoRequest> get serializer =>
      _$CreatePromoRequestSerializer();
}

class _$CreatePromoRequestSerializer
    implements PrimitiveSerializer<CreatePromoRequest> {
  @override
