...
/// * [licenseNumber]
@BuiltValue()
abstract class CreateDriverRequest
    implements Built<CreateDriverRequest, CreateDriverRequestBuilder> {
  ...
  factory CreateDriverRequest([void updates(CreateDriverRequestBuilder b)]) =
      _$CreateDriverRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateDriverRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateDriverRequest> get serializer =>
      _$CreateDriverRequestSerializer();
}

class _$CreateDriverRequestSerializer
    implements PrimitiveSerializer<CreateDriverRequest> {
  @override
