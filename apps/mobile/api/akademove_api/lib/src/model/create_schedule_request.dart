...
/// * [isActive]
@BuiltValue()
abstract class CreateScheduleRequest
    implements Built<CreateScheduleRequest, CreateScheduleRequestBuilder> {
  ...
  factory CreateScheduleRequest(
      [void updates(CreateScheduleRequestBuilder b)]) = _$CreateScheduleRequest;
  ...
  static Serializer<CreateScheduleRequest> get serializer =>
      _$CreateScheduleRequestSerializer();
}

class _$CreateScheduleRequestSerializer
    implements PrimitiveSerializer<CreateScheduleRequest> {
  @override
...
class CreateScheduleRequestDayOfWeekEnum extends EnumClass {
  ...
  static const CreateScheduleRequestDayOfWeekEnum sunday =
      _$createScheduleRequestDayOfWeekEnum_sunday;
  @BuiltValueEnumConst(wireName: r'monday')
  static const CreateScheduleRequestDayOfWeekEnum monday =
      _$createScheduleRequestDayOfWeekEnum_monday;
  @BuiltValueEnumConst(wireName: r'tuesday')
  static const CreateScheduleRequestDayOfWeekEnum tuesday =
      _$createScheduleRequestDayOfWeekEnum_tuesday;
  @BuiltValueEnumConst(wireName: r'wednesday')
  static const CreateScheduleRequestDayOfWeekEnum wednesday =
      _$createScheduleRequestDayOfWeekEnum_wednesday;
  @BuiltValueEnumConst(wireName: r'thursday')
  static const CreateScheduleRequestDayOfWeekEnum thursday =
      _$createScheduleRequestDayOfWeekEnum_thursday;
  @BuiltValueEnumConst(wireName: r'friday')
  static const CreateScheduleRequestDayOfWeekEnum friday =
      _$createScheduleRequestDayOfWeekEnum_friday;
  @BuiltValueEnumConst(wireName: r'saturday')
  static const CreateScheduleRequestDayOfWeekEnum saturday =
      _$createScheduleRequestDayOfWeekEnum_saturday;

  static Serializer<CreateScheduleRequestDayOfWeekEnum> get serializer =>
      _$createScheduleRequestDayOfWeekEnumSerializer;

  const CreateScheduleRequestDayOfWeekEnum._(String name) : super(name);

  static BuiltSet<CreateScheduleRequestDayOfWeekEnum> get values =>
      _$createScheduleRequestDayOfWeekEnumValues;
  static CreateScheduleRequestDayOfWeekEnum valueOf(String name) =>
      _$createScheduleRequestDayOfWeekEnumValueOf(name);
}
