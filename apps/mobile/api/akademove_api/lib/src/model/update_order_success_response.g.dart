...
final BuiltSet<UpdateOrderSuccessResponseSuccessEnum>
    _$updateOrderSuccessResponseSuccessEnumValues = BuiltSet<
        UpdateOrderSuccessResponseSuccessEnum>(const <UpdateOrderSuccessResponseSuccessEnum>[
  _$updateOrderSuccessResponseSuccessEnum_true_,
]);
...
class _$UpdateOrderSuccessResponseSuccessEnumSerializer
  ...
  @override
  Object serialize(
          Serializers serializers, UpdateOrderSuccessResponseSuccessEnum object,
    ...
    try {
      _$result = _$v ??
          _$UpdateOrderSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'UpdateOrderSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'UpdateOrderSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'UpdateOrderSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
