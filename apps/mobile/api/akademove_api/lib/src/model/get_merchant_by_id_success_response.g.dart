...
final BuiltSet<GetMerchantByIdSuccessResponseSuccessEnum>
    _$getMerchantByIdSuccessResponseSuccessEnumValues = BuiltSet<
        GetMerchantByIdSuccessResponseSuccessEnum>(const <GetMerchantByIdSuccessResponseSuccessEnum>[
  _$getMerchantByIdSuccessResponseSuccessEnum_true_,
]);
...
class GetMerchantByIdSuccessResponseBuilder
    implements
        Builder<GetMerchantByIdSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$GetMerchantByIdSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'GetMerchantByIdSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'GetMerchantByIdSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GetMerchantByIdSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
