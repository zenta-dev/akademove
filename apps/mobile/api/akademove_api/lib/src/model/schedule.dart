...
class ScheduleDayOfWeekEnum extends EnumClass {
  ...
  static const ScheduleDayOfWeekEnum wednesday =
      _$scheduleDayOfWeekEnum_wednesday;
  @BuiltValueEnumConst(wireName: r'thursday')
  static const ScheduleDayOfWeekEnum thursday =
  ...
  static const ScheduleDayOfWeekEnum saturday =
      _$scheduleDayOfWeekEnum_saturday;

  static Serializer<ScheduleDayOfWeekEnum> get serializer =>
      _$scheduleDayOfWeekEnumSerializer;

  const ScheduleDayOfWeekEnum._(String name) : super(name);

  static BuiltSet<ScheduleDayOfWeekEnum> get values =>
      _$scheduleDayOfWeekEnumValues;
  static ScheduleDayOfWeekEnum valueOf(String name) =>
      _$scheduleDayOfWeekEnumValueOf(name);
}
