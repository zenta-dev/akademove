...
final BuiltSet<DeleteOrderSuccessResponseSuccessEnum>
    _$deleteOrderSuccessResponseSuccessEnumValues = BuiltSet<
        DeleteOrderSuccessResponseSuccessEnum>(const <DeleteOrderSuccessResponseSuccessEnum>[
  _$deleteOrderSuccessResponseSuccessEnum_true_,
]);
...
class _$DeleteOrderSuccessResponseSuccessEnumSerializer
  ...
  @override
  Object serialize(
          Serializers serializers, DeleteOrderSuccessResponseSuccessEnum object,
    ...
    final _$result = _$v ??
        _$DeleteOrderSuccessResponse._(
          success: BuiltValueNullFieldError.checkNotNull(
              success, r'DeleteOrderSuccessResponse', 'success'),
          message: BuiltValueNullFieldError.checkNotNull(
              message, r'DeleteOrderSuccessResponse', 'message'),
          data: data,
        );
    replace(_$result);
    return _$result;
