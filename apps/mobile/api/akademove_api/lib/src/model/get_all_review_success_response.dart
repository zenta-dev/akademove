...
/// * [data]
@BuiltValue()
abstract class GetAllReviewSuccessResponse
    implements
        Built<GetAllReviewSuccessResponse, GetAllReviewSuccessResponseBuilder> {
  ...
  factory GetAllReviewSuccessResponse(
          [void updates(GetAllReviewSuccessResponseBuilder b)]) =
      _$GetAllReviewSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GetAllReviewSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetAllReviewSuccessResponse> get serializer =>
      _$GetAllReviewSuccessResponseSerializer();
}

class _$GetAllReviewSuccessResponseSerializer
    implements PrimitiveSerializer<GetAllReviewSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(GetAllReviewSuccessResponseSuccessEnum),
...
class GetAllReviewSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const GetAllReviewSuccessResponseSuccessEnum true_ =
      _$getAllReviewSuccessResponseSuccessEnum_true_;

  static Serializer<GetAllReviewSuccessResponseSuccessEnum> get serializer =>
      _$getAllReviewSuccessResponseSuccessEnumSerializer;

  const GetAllReviewSuccessResponseSuccessEnum._(String name) : super(name);

  static BuiltSet<GetAllReviewSuccessResponseSuccessEnum> get values =>
      _$getAllReviewSuccessResponseSuccessEnumValues;
  static GetAllReviewSuccessResponseSuccessEnum valueOf(String name) =>
      _$getAllReviewSuccessResponseSuccessEnumValueOf(name);
}
