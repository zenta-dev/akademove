...
/// * [data]
@BuiltValue()
abstract class DeleteReportSuccessResponse
    implements
        Built<DeleteReportSuccessResponse, DeleteReportSuccessResponseBuilder> {
  ...
  factory DeleteReportSuccessResponse(
          [void updates(DeleteReportSuccessResponseBuilder b)]) =
      _$DeleteReportSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DeleteReportSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DeleteReportSuccessResponse> get serializer =>
      _$DeleteReportSuccessResponseSerializer();
}

class _$DeleteReportSuccessResponseSerializer
    implements PrimitiveSerializer<DeleteReportSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(DeleteReportSuccessResponseSuccessEnum),
...
class DeleteReportSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const DeleteReportSuccessResponseSuccessEnum true_ =
      _$deleteReportSuccessResponseSuccessEnum_true_;

  static Serializer<DeleteReportSuccessResponseSuccessEnum> get serializer =>
      _$deleteReportSuccessResponseSuccessEnumSerializer;

  const DeleteReportSuccessResponseSuccessEnum._(String name) : super(name);

  static BuiltSet<DeleteReportSuccessResponseSuccessEnum> get values =>
      _$deleteReportSuccessResponseSuccessEnumValues;
  static DeleteReportSuccessResponseSuccessEnum valueOf(String name) =>
      _$deleteReportSuccessResponseSuccessEnumValueOf(name);
}
