...
/// * [data]
@BuiltValue()
abstract class DeletePromoSuccessResponse
    implements
        Built<DeletePromoSuccessResponse, DeletePromoSuccessResponseBuilder> {
  ...
  factory DeletePromoSuccessResponse(
          [void updates(DeletePromoSuccessResponseBuilder b)]) =
      _$DeletePromoSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DeletePromoSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DeletePromoSuccessResponse> get serializer =>
      _$DeletePromoSuccessResponseSerializer();
}

class _$DeletePromoSuccessResponseSerializer
    implements PrimitiveSerializer<DeletePromoSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(DeletePromoSuccessResponseSuccessEnum),
...
class DeletePromoSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const DeletePromoSuccessResponseSuccessEnum true_ =
      _$deletePromoSuccessResponseSuccessEnum_true_;

  static Serializer<DeletePromoSuccessResponseSuccessEnum> get serializer =>
      _$deletePromoSuccessResponseSuccessEnumSerializer;

  const DeletePromoSuccessResponseSuccessEnum._(String name) : super(name);

  static BuiltSet<DeletePromoSuccessResponseSuccessEnum> get values =>
      _$deletePromoSuccessResponseSuccessEnumValues;
  static DeletePromoSuccessResponseSuccessEnum valueOf(String name) =>
      _$deletePromoSuccessResponseSuccessEnumValueOf(name);
}
