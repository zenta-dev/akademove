...
final BuiltSet<DeletePromoSuccessResponseSuccessEnum>
    _$deletePromoSuccessResponseSuccessEnumValues = BuiltSet<
        DeletePromoSuccessResponseSuccessEnum>(const <DeletePromoSuccessResponseSuccessEnum>[
  _$deletePromoSuccessResponseSuccessEnum_true_,
]);
...
class _$DeletePromoSuccessResponseSuccessEnumSerializer
  ...
  @override
  Object serialize(
          Serializers serializers, DeletePromoSuccessResponseSuccessEnum object,
    ...
    final _$result = _$v ??
        _$DeletePromoSuccessResponse._(
          success: BuiltValueNullFieldError.checkNotNull(
              success, r'DeletePromoSuccessResponse', 'success'),
          message: BuiltValueNullFieldError.checkNotNull(
              message, r'DeletePromoSuccessResponse', 'message'),
          data: data,
        );
    replace(_$result);
    return _$result;
