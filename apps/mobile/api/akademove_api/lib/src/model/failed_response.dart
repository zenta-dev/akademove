...
/// * [errors]
@BuiltValue()
abstract class FailedResponse
    implements Built<FailedResponse, FailedResponseBuilder> {
  ...
  factory FailedResponse([void updates(FailedResponseBuilder b)]) =
      _$FailedResponse;
  ...
  static Serializer<FailedResponse> get serializer =>
      _$FailedResponseSerializer();
}

class _$FailedResponseSerializer
    implements PrimitiveSerializer<FailedResponse> {
  @override
...
class FailedResponseSuccessEnum extends EnumClass {
  ...
  static const FailedResponseSuccessEnum false_ =
      _$failedResponseSuccessEnum_false_;

  static Serializer<FailedResponseSuccessEnum> get serializer =>
      _$failedResponseSuccessEnumSerializer;

  const FailedResponseSuccessEnum._(String name) : super(name);

  static BuiltSet<FailedResponseSuccessEnum> get values =>
      _$failedResponseSuccessEnumValues;
  static FailedResponseSuccessEnum valueOf(String name) =>
      _$failedResponseSuccessEnumValueOf(name);
}
