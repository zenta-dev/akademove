...
abstract class Merchant implements Built<Merchant, MerchantBuilder> {
  ...
  static void _defaults(MerchantBuilder b) => b..isActive = true;
...
class MerchantTypeEnum extends EnumClass {
  ...
  static Serializer<MerchantTypeEnum> get serializer =>
  ...
  static MerchantTypeEnum valueOf(String name) =>
      _$merchantTypeEnumValueOf(name);
}
