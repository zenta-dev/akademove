...
final BuiltSet<DeleteReportSuccessResponseSuccessEnum>
    _$deleteReportSuccessResponseSuccessEnumValues = BuiltSet<
        DeleteReportSuccessResponseSuccessEnum>(const <DeleteReportSuccessResponseSuccessEnum>[
  _$deleteReportSuccessResponseSuccessEnum_true_,
]);
...
class DeleteReportSuccessResponseBuilder
    implements
        Builder<DeleteReportSuccessResponse,
    ...
    final _$result = _$v ??
        _$DeleteReportSuccessResponse._(
          success: BuiltValueNullFieldError.checkNotNull(
              success, r'DeleteReportSuccessResponse', 'success'),
          message: BuiltValueNullFieldError.checkNotNull(
              message, r'DeleteReportSuccessResponse', 'message'),
          data: data,
        );
    replace(_$result);
    return _$result;
