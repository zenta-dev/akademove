...
/// * [dropoff]
@BuiltValue()
abstract class CreateOrderRequestNote
    implements Built<CreateOrderRequestNote, CreateOrderRequestNoteBuilder> {
  ...
  factory CreateOrderRequestNote(
          [void updates(CreateOrderRequestNoteBuilder b)]) =
      _$CreateOrderRequestNote;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateOrderRequestNoteBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateOrderRequestNote> get serializer =>
      _$CreateOrderRequestNoteSerializer();
}

class _$CreateOrderRequestNoteSerializer
    implements PrimitiveSerializer<CreateOrderRequestNote> {
  @override
