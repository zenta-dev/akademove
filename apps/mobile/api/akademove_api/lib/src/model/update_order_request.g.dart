...
class _$UpdateOrderRequestTypeEnumSerializer
  ...
  @override
  Object serialize(Serializers serializers, UpdateOrderRequestTypeEnum object,
...
class _$UpdateOrderRequestStatusEnumSerializer
  ...
  @override
  Object serialize(Serializers serializers, UpdateOrderRequestStatusEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;
    ...
    try {
      _$result = _$v ??
          _$UpdateOrderRequest._(
            ...
            type: BuiltValueNullFieldError.checkNotNull(
                type, r'UpdateOrderRequest', 'type'),
            status: BuiltValueNullFieldError.checkNotNull(
                status, r'UpdateOrderRequest', 'status'),
            distanceKm: BuiltValueNullFieldError.checkNotNull(
                distanceKm, r'UpdateOrderRequest', 'distanceKm'),
            totalPrice: BuiltValueNullFieldError.checkNotNull(
                totalPrice, r'UpdateOrderRequest', 'totalPrice'),
            note: _note?.build(),
            tip: tip,
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'UpdateOrderRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
