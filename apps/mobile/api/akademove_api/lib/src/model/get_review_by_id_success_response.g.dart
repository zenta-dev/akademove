...
final BuiltSet<GetReviewByIdSuccessResponseSuccessEnum>
    _$getReviewByIdSuccessResponseSuccessEnumValues = BuiltSet<
        GetReviewByIdSuccessResponseSuccessEnum>(const <GetReviewByIdSuccessResponseSuccessEnum>[
  _$getReviewByIdSuccessResponseSuccessEnum_true_,
]);
...
class GetReviewByIdSuccessResponseBuilder
    implements
        Builder<GetReviewByIdSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$GetReviewByIdSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'GetReviewByIdSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'GetReviewByIdSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GetReviewByIdSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
