...
final BuiltSet<GetPromoByIdSuccessResponseSuccessEnum>
    _$getPromoByIdSuccessResponseSuccessEnumValues = BuiltSet<
        GetPromoByIdSuccessResponseSuccessEnum>(const <GetPromoByIdSuccessResponseSuccessEnum>[
  _$getPromoByIdSuccessResponseSuccessEnum_true_,
]);
...
class GetPromoByIdSuccessResponseBuilder
    implements
        Builder<GetPromoByIdSuccessResponse,
    ...
    try {
      _$result = _$v ??
          _$GetPromoByIdSuccessResponse._(
            success: BuiltValueNullFieldError.checkNotNull(
                success, r'GetPromoByIdSuccessResponse', 'success'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'GetPromoByIdSuccessResponse', 'message'),
            data: data.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GetPromoByIdSuccessResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
