...
/// * [data]
@BuiltValue()
abstract class DeleteOrderSuccessResponse
    implements
        Built<DeleteOrderSuccessResponse, DeleteOrderSuccessResponseBuilder> {
  ...
  factory DeleteOrderSuccessResponse(
          [void updates(DeleteOrderSuccessResponseBuilder b)]) =
      _$DeleteOrderSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DeleteOrderSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DeleteOrderSuccessResponse> get serializer =>
      _$DeleteOrderSuccessResponseSerializer();
}

class _$DeleteOrderSuccessResponseSerializer
    implements PrimitiveSerializer<DeleteOrderSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(DeleteOrderSuccessResponseSuccessEnum),
...
class DeleteOrderSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const DeleteOrderSuccessResponseSuccessEnum true_ =
      _$deleteOrderSuccessResponseSuccessEnum_true_;

  static Serializer<DeleteOrderSuccessResponseSuccessEnum> get serializer =>
      _$deleteOrderSuccessResponseSuccessEnumSerializer;

  const DeleteOrderSuccessResponseSuccessEnum._(String name) : super(name);

  static BuiltSet<DeleteOrderSuccessResponseSuccessEnum> get values =>
      _$deleteOrderSuccessResponseSuccessEnumValues;
  static DeleteOrderSuccessResponseSuccessEnum valueOf(String name) =>
      _$deleteOrderSuccessResponseSuccessEnumValueOf(name);
}
