...
/// * [data]
@BuiltValue()
abstract class GetAllMerchantSuccessResponse
    implements
        Built<GetAllMerchantSuccessResponse,
  ...
  factory GetAllMerchantSuccessResponse(
          [void updates(GetAllMerchantSuccessResponseBuilder b)]) =
      _$GetAllMerchantSuccessResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GetAllMerchantSuccessResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetAllMerchantSuccessResponse> get serializer =>
      _$GetAllMerchantSuccessResponseSerializer();
}

class _$GetAllMerchantSuccessResponseSerializer
    implements PrimitiveSerializer<GetAllMerchantSuccessResponse> {
  @override
      ...
      switch (key) {
        case r'success':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(GetAllMerchantSuccessResponseSuccessEnum),
...
class GetAllMerchantSuccessResponseSuccessEnum extends EnumClass {
  ...
  static const GetAllMerchantSuccessResponseSuccessEnum true_ =
      _$getAllMerchantSuccessResponseSuccessEnum_true_;

  static Serializer<GetAllMerchantSuccessResponseSuccessEnum> get serializer =>
  ...
  static BuiltSet<GetAllMerchantSuccessResponseSuccessEnum> get values =>
      _$getAllMerchantSuccessResponseSuccessEnumValues;
  static GetAllMerchantSuccessResponseSuccessEnum valueOf(String name) =>
      _$getAllMerchantSuccessResponseSuccessEnumValueOf(name);
}
