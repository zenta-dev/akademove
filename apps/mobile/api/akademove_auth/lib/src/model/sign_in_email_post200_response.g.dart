...
final BuiltSet<SignInEmailPost200ResponseRedirectEnum>
    _$signInEmailPost200ResponseRedirectEnumValues = BuiltSet<
        SignInEmailPost200ResponseRedirectEnum>(const <SignInEmailPost200ResponseRedirectEnum>[
  _$signInEmailPost200ResponseRedirectEnum_false_,
]);
    ...
    try {
      _$result = _$v ??
          _$SignInEmailPost200Response._(
            redirect: BuiltValueNullFieldError.checkNotNull(
                redirect, r'SignInEmailPost200Response', 'redirect'),
            token: BuiltValueNullFieldError.checkNotNull(
                token, r'SignInEmailPost200Response', 'token'),
            user: user.build(),
            url: url,
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'SignInEmailPost200Response', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
