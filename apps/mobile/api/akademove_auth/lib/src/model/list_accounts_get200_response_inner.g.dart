...
class ListAccountsGet200ResponseInnerBuilder
    implements
        Builder<ListAccountsGet200ResponseInner,
    ...
    try {
      _$result = _$v ??
          _$ListAccountsGet200ResponseInner._(
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'ListAccountsGet200ResponseInner', 'id'),
            providerId: BuiltValueNullFieldError.checkNotNull(
                providerId, r'ListAccountsGet200ResponseInner', 'providerId'),
            createdAt: BuiltValueNullFieldError.checkNotNull(
                createdAt, r'ListAccountsGet200ResponseInner', 'createdAt'),
            updatedAt: BuiltValueNullFieldError.checkNotNull(
                updatedAt, r'ListAccountsGet200ResponseInner', 'updatedAt'),
            accountId: BuiltValueNullFieldError.checkNotNull(
                accountId, r'ListAccountsGet200ResponseInner', 'accountId'),
            scopes: scopes.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'ListAccountsGet200ResponseInner', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
