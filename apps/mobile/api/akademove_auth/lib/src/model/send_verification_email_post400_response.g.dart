...
class _$SendVerificationEmailPost400Response
  ...
  factory _$SendVerificationEmailPost400Response(
          [void Function(SendVerificationEmailPost400ResponseBuilder)?
              updates]) =>
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SendVerificationEmailPost400Response')
          ..add('message', message))
        .toString();
  }
}
...
class SendVerificationEmailPost400ResponseBuilder
    implements
        Builder<SendVerificationEmailPost400Response,
  ...
  _$SendVerificationEmailPost400Response _build() {
    final _$result = _$v ??
        _$SendVerificationEmailPost400Response._(
          message: message,
        );
    replace(_$result);
    return _$result;
