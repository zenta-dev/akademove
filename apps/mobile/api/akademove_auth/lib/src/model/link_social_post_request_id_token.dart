...
/// * [scopes]
@BuiltValue()
abstract class LinkSocialPostRequestIdToken
    implements
        Built<LinkSocialPostRequestIdToken,
  ...
  factory LinkSocialPostRequestIdToken(
          [void updates(LinkSocialPostRequestIdTokenBuilder b)]) =
      _$LinkSocialPostRequestIdToken;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LinkSocialPostRequestIdTokenBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LinkSocialPostRequestIdToken> get serializer =>
      _$LinkSocialPostRequestIdTokenSerializer();
}

class _$LinkSocialPostRequestIdTokenSerializer
    implements PrimitiveSerializer<LinkSocialPostRequestIdToken> {
  @override
