...
@BuiltValue()
abstract class LinkSocialPostRequest
    implements Built<LinkSocialPostRequest, LinkSocialPostRequestBuilder> {
  ...
  factory LinkSocialPostRequest(
      [void updates(LinkSocialPostRequestBuilder b)]) = _$LinkSocialPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LinkSocialPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LinkSocialPostRequest> get serializer =>
      _$LinkSocialPostRequestSerializer();
}

class _$LinkSocialPostRequestSerializer
    implements PrimitiveSerializer<LinkSocialPostRequest> {
  @override
  final Iterable<Type> types = const [
    LinkSocialPostRequest,
    _$LinkSocialPostRequest
  ];
