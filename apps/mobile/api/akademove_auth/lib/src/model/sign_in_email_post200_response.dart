...
/// * [url]
@BuiltValue()
abstract class SignInEmailPost200Response
    implements
        Built<SignInEmailPost200Response, SignInEmailPost200ResponseBuilder> {
  ...
  factory SignInEmailPost200Response(
          [void updates(SignInEmailPost200ResponseBuilder b)]) =
      _$SignInEmailPost200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SignInEmailPost200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SignInEmailPost200Response> get serializer =>
      _$SignInEmailPost200ResponseSerializer();
}

class _$SignInEmailPost200ResponseSerializer
    implements PrimitiveSerializer<SignInEmailPost200Response> {
  @override
      ...
      switch (key) {
        case r'redirect':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(SignInEmailPost200ResponseRedirectEnum),
...
class SignInEmailPost200ResponseRedirectEnum extends EnumClass {
  ...
  static const SignInEmailPost200ResponseRedirectEnum false_ =
      _$signInEmailPost200ResponseRedirectEnum_false_;

  static Serializer<SignInEmailPost200ResponseRedirectEnum> get serializer =>
      _$signInEmailPost200ResponseRedirectEnumSerializer;

  const SignInEmailPost200ResponseRedirectEnum._(String name) : super(name);

  static BuiltSet<SignInEmailPost200ResponseRedirectEnum> get values =>
      _$signInEmailPost200ResponseRedirectEnumValues;
  static SignInEmailPost200ResponseRedirectEnum valueOf(String name) =>
      _$signInEmailPost200ResponseRedirectEnumValueOf(name);
}
