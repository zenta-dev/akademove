...
class _$SendVerificationEmailPost200Response
  ...
  factory _$SendVerificationEmailPost200Response(
          [void Function(SendVerificationEmailPost200ResponseBuilder)?
              updates]) =>
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SendVerificationEmailPost200Response')
          ..add('status', status))
        .toString();
  }
}
...
class SendVerificationEmailPost200ResponseBuilder
    implements
        Builder<SendVerificationEmailPost200Response,
  ...
  _$SendVerificationEmailPost200Response _build() {
    final _$result = _$v ??
        _$SendVerificationEmailPost200Response._(
          status: status,
        );
    replace(_$result);
    return _$result;
