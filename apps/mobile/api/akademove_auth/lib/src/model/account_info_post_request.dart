...
@BuiltValue()
abstract class AccountInfoPostRequest
    implements Built<AccountInfoPostRequest, AccountInfoPostRequestBuilder> {
  ...
  factory AccountInfoPostRequest(
          [void updates(AccountInfoPostRequestBuilder b)]) =
      _$AccountInfoPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccountInfoPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccountInfoPostRequest> get serializer =>
      _$AccountInfoPostRequestSerializer();
}

class _$AccountInfoPostRequestSerializer
    implements PrimitiveSerializer<AccountInfoPostRequest> {
  @override
