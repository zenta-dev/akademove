...
@BuiltValue()
abstract class SocialSignInRequest
    implements Built<SocialSignInRequest, SocialSignInRequestBuilder> {
  ...
  factory SocialSignInRequest([void updates(SocialSignInRequestBuilder b)]) =
      _$SocialSignInRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SocialSignInRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SocialSignInRequest> get serializer =>
      _$SocialSignInRequestSerializer();
}

class _$SocialSignInRequestSerializer
    implements PrimitiveSerializer<SocialSignInRequest> {
  @override
