...
@BuiltValue()
abstract class ChangePasswordPostRequest
    implements
        Built<ChangePasswordPostRequest, ChangePasswordPostRequestBuilder> {
  ...
  factory ChangePasswordPostRequest(
          [void updates(ChangePasswordPostRequestBuilder b)]) =
      _$ChangePasswordPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ChangePasswordPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ChangePasswordPostRequest> get serializer =>
      _$ChangePasswordPostRequestSerializer();
}

class _$ChangePasswordPostRequestSerializer
    implements PrimitiveSerializer<ChangePasswordPostRequest> {
  @override
