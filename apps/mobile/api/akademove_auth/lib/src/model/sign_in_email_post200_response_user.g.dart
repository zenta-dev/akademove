...
class SignInEmailPost200ResponseUserBuilder
    implements
        Builder<SignInEmailPost200ResponseUser,
    ...
    final _$result = _$v ??
        _$SignInEmailPost200ResponseUser._(
          id: BuiltValueNullFieldError.checkNotNull(
              id, r'SignInEmailPost200ResponseUser', 'id'),
          email: BuiltValueNullFieldError.checkNotNull(
              email, r'SignInEmailPost200ResponseUser', 'email'),
          emailVerified: BuiltValueNullFieldError.checkNotNull(emailVerified,
              r'SignInEmailPost200ResponseUser', 'emailVerified'),
          createdAt: BuiltValueNullFieldError.checkNotNull(
              createdAt, r'SignInEmailPost200ResponseUser', 'createdAt'),
          updatedAt: BuiltValueNullFieldError.checkNotNull(
              updatedAt, r'SignInEmailPost200ResponseUser', 'updatedAt'),
          name: name,
          image: image,
        );
    replace(_$result);
