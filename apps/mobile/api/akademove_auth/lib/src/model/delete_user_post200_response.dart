...
@BuiltValue()
abstract class DeleteUserPost200Response
    implements
        Built<DeleteUserPost200Response, DeleteUserPost200ResponseBuilder> {
  ...
  factory DeleteUserPost200Response(
          [void updates(DeleteUserPost200ResponseBuilder b)]) =
      _$DeleteUserPost200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DeleteUserPost200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DeleteUserPost200Response> get serializer =>
      _$DeleteUserPost200ResponseSerializer();
}

class _$DeleteUserPost200ResponseSerializer
    implements PrimitiveSerializer<DeleteUserPost200Response> {
  @override
...
class DeleteUserPost200ResponseMessageEnum extends EnumClass {
  ...
  static const DeleteUserPost200ResponseMessageEnum userDeleted =
      _$deleteUserPost200ResponseMessageEnum_userDeleted;

  /// Status message of the deletion process
  @BuiltValueEnumConst(wireName: r'Verification email sent')
  static const DeleteUserPost200ResponseMessageEnum verificationEmailSent =
      _$deleteUserPost200ResponseMessageEnum_verificationEmailSent;

  static Serializer<DeleteUserPost200ResponseMessageEnum> get serializer =>
      _$deleteUserPost200ResponseMessageEnumSerializer;

  const DeleteUserPost200ResponseMessageEnum._(String name) : super(name);

  static BuiltSet<DeleteUserPost200ResponseMessageEnum> get values =>
      _$deleteUserPost200ResponseMessageEnumValues;
  static DeleteUserPost200ResponseMessageEnum valueOf(String name) =>
      _$deleteUserPost200ResponseMessageEnumValueOf(name);
}
