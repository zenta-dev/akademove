...
@BuiltValue()
abstract class DeleteUserPostRequest
    implements Built<DeleteUserPostRequest, DeleteUserPostRequestBuilder> {
  ...
  factory DeleteUserPostRequest(
      [void updates(DeleteUserPostRequestBuilder b)]) = _$DeleteUserPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DeleteUserPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DeleteUserPostRequest> get serializer =>
      _$DeleteUserPostRequestSerializer();
}

class _$DeleteUserPostRequestSerializer
    implements PrimitiveSerializer<DeleteUserPostRequest> {
  @override
  final Iterable<Type> types = const [
    DeleteUserPostRequest,
    _$DeleteUserPostRequest
  ];
