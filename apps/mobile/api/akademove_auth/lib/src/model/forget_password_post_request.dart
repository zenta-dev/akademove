...
@BuiltValue()
abstract class ForgetPasswordPostRequest
    implements
        Built<ForgetPasswordPostRequest, ForgetPasswordPostRequestBuilder> {
  ...
  factory ForgetPasswordPostRequest(
          [void updates(ForgetPasswordPostRequestBuilder b)]) =
      _$ForgetPasswordPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ForgetPasswordPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ForgetPasswordPostRequest> get serializer =>
      _$ForgetPasswordPostRequestSerializer();
}

class _$ForgetPasswordPostRequestSerializer
    implements PrimitiveSerializer<ForgetPasswordPostRequest> {
  @override
