...
@BuiltValue()
abstract class SocialSignInRequestIdToken
    implements
        Built<SocialSignInRequestIdToken, SocialSignInRequestIdTokenBuilder> {
  ...
  factory SocialSignInRequestIdToken(
          [void updates(SocialSignInRequestIdTokenBuilder b)]) =
      _$SocialSignInRequestIdToken;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SocialSignInRequestIdTokenBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SocialSignInRequestIdToken> get serializer =>
      _$SocialSignInRequestIdTokenSerializer();
}

class _$SocialSignInRequestIdTokenSerializer
    implements PrimitiveSerializer<SocialSignInRequestIdToken> {
  @override
