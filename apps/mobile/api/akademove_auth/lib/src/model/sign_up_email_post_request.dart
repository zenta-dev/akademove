...
@BuiltValue()
abstract class SignUpEmailPostRequest
    implements Built<SignUpEmailPostRequest, SignUpEmailPostRequestBuilder> {
  ...
  factory SignUpEmailPostRequest(
          [void updates(SignUpEmailPostRequestBuilder b)]) =
      _$SignUpEmailPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SignUpEmailPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SignUpEmailPostRequest> get serializer =>
      _$SignUpEmailPostRequestSerializer();
}

class _$SignUpEmailPostRequestSerializer
    implements PrimitiveSerializer<SignUpEmailPostRequest> {
  @override
