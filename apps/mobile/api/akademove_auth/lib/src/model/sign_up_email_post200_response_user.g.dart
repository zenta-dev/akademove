...
class SignUpEmailPost200ResponseUserBuilder
    implements
        Builder<SignUpEmailPost200ResponseUser,
    ...
    final _$result = _$v ??
        _$SignUpEmailPost200ResponseUser._(
          id: BuiltValueNullFieldError.checkNotNull(
              id, r'SignUpEmailPost200ResponseUser', 'id'),
          email: BuiltValueNullFieldError.checkNotNull(
              email, r'SignUpEmailPost200ResponseUser', 'email'),
          name: BuiltValueNullFieldError.checkNotNull(
              name, r'SignUpEmailPost200ResponseUser', 'name'),
          emailVerified: BuiltValueNullFieldError.checkNotNull(emailVerified,
              r'SignUpEmailPost200ResponseUser', 'emailVerified'),
          createdAt: BuiltValueNullFieldError.checkNotNull(
              createdAt, r'SignUpEmailPost200ResponseUser', 'createdAt'),
          updatedAt: BuiltValueNullFieldError.checkNotNull(
              updatedAt, r'SignUpEmailPost200ResponseUser', 'updatedAt'),
          image: image,
        );
    replace(_$result);
    return _$result;
