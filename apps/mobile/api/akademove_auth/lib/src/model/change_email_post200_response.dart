...
@BuiltValue()
abstract class ChangeEmailPost200Response
    implements
        Built<ChangeEmailPost200Response, ChangeEmailPost200ResponseBuilder> {
  ...
  factory ChangeEmailPost200Response(
          [void updates(ChangeEmailPost200ResponseBuilder b)]) =
      _$ChangeEmailPost200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ChangeEmailPost200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ChangeEmailPost200Response> get serializer =>
      _$ChangeEmailPost200ResponseSerializer();
}

class _$ChangeEmailPost200ResponseSerializer
    implements PrimitiveSerializer<ChangeEmailPost200Response> {
  @override
      ...
      switch (key) {
        ...
        case r'message':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(ChangeEmailPost200ResponseMessageEnum),
...
class ChangeEmailPost200ResponseMessageEnum extends EnumClass {
  ...
  static const ChangeEmailPost200ResponseMessageEnum emailUpdated =
      _$changeEmailPost200ResponseMessageEnum_emailUpdated;

  /// Status message of the email change process
  @BuiltValueEnumConst(wireName: r'Verification email sent')
  static const ChangeEmailPost200ResponseMessageEnum verificationEmailSent =
      _$changeEmailPost200ResponseMessageEnum_verificationEmailSent;

  static Serializer<ChangeEmailPost200ResponseMessageEnum> get serializer =>
      _$changeEmailPost200ResponseMessageEnumSerializer;

  const ChangeEmailPost200ResponseMessageEnum._(String name) : super(name);

  static BuiltSet<ChangeEmailPost200ResponseMessageEnum> get values =>
      _$changeEmailPost200ResponseMessageEnumValues;
  static ChangeEmailPost200ResponseMessageEnum valueOf(String name) =>
      _$changeEmailPost200ResponseMessageEnumValueOf(name);
}
