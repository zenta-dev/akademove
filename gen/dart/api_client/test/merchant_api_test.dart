...
void main() {
  ...
  group(MerchantApi, () {
    ...
    //Future<MerchantGetMine200ResponseBody> merchantUpdate(String id, num locationLat, num locationLng, { String type, String name, String email, String phone, String address, MultipartFile document }) async
