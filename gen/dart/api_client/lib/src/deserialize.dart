  ...
  ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType, {bool growable= true}) {
      switch (targetType) {
        ...
        case 'AuthGetSession200ResponseData':
          return AuthGetSession200ResponseData.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'AuthResetPasswordRequest':
          return AuthResetPasswordRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'AuthSignIn200ResponseData':
          return AuthSignIn200ResponseData.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AuthSignInRequest':
          return AuthSignInRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'AuthSignUpUser201ResponseData':
          return AuthSignUpUser201ResponseData.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'BanUserSchemaRequest':
          return BanUserSchemaRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Bank':
        ...
        case 'ConfigurationUpdateRequest':
          return ConfigurationUpdateRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Coupon':
        ...
        case 'CouponCreateRequest':
          return CouponCreateRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CouponCreateRequestRules':
          return CouponCreateRequestRules.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CouponCreateRequestRulesGeneral':
          return CouponCreateRequestRulesGeneral.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CouponCreateRequestRulesTime':
          return CouponCreateRequestRulesTime.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CouponCreateRequestRulesUser':
          return CouponCreateRequestRulesUser.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'CouponUpdateRequest':
          return CouponUpdateRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Driver':
        ...
        case 'DriverRemove200Response':
          return DriverRemove200Response.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'MerchantList200Response':
          return MerchantList200Response.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'MerchantMenu':
        ...
        case 'OrderCreate200Response':
          return OrderCreate200Response.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrderCreateRequest':
          return OrderCreateRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrderCreateRequestDriver':
          return OrderCreateRequestDriver.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrderCreateRequestItemsInner':
          return OrderCreateRequestItemsInner.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrderCreateRequestItemsInnerItem':
          return OrderCreateRequestItemsInnerItem.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrderCreateRequestMerchant':
          return OrderCreateRequestMerchant.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrderCreateRequestNote':
          return OrderCreateRequestNote.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrderCreateRequestUser':
          return OrderCreateRequestUser.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'OrderUpdateRequest':
          return OrderUpdateRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Phone':
        ...
        case 'ReportCreateRequest':
          return ReportCreateRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'ReportUpdateRequest':
          return ReportUpdateRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Review':
        ...
        case 'ReviewCreateRequest':
          return ReviewCreateRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'ReviewUpdateRequest':
          return ReviewUpdateRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Schedule':
          return Schedule.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ScheduleCreate200Response':
          return ScheduleCreate200Response.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ScheduleCreateRequest':
          return ScheduleCreateRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ScheduleList200Response':
          return ScheduleList200Response.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ScheduleUpdateRequest':
          return ScheduleUpdateRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Statements':
        ...
        case 'UnbanUserSchemaRequest':
          return UnbanUserSchemaRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdateUserPasswordRequest':
          return UpdateUserPasswordRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdateUserRoleRequest':
          return UpdateUserRoleRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'User':
          return User.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UserCreate200Response':
          return UserCreate200Response.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UserCreateRequest':
          return UserCreateRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UserList200Response':
          return UserList200Response.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UserUpdateRequest':
          return UserUpdateRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        default:
          RegExpMatch? match;
