...
class CouponApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CouponList200Response>> couponGetAvailableCoupons({
    ...
    final _path = r'/coupons/available';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
  ...
  couponGetEligibleCoupons({
    ...
    CouponGetEligibleCoupons200Response? _responseData;
    ...
    return Response<CouponGetEligibleCoupons200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<CouponValidate200Response>> couponValidate({
    ...
    CouponValidate200Response? _responseData;
    ...
    return Response<CouponValidate200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
