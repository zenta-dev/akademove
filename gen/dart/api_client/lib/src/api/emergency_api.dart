...
class EmergencyApi {
  ...
  emergencyContactCreate({
    ...
    final _path = r'/emergency-contacts';
    ...
    try {
      _bodyData = jsonEncode(insertEmergencyContact);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BannerDelete200Response>> emergencyContactDelete({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/emergency-contacts/{id}'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmergencyContactListActive200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmergencyContactListActive200Response>> emergencyContactList({
    String? cursor,
    Object? limit,
    String? direction,
    Object? page,
    ...
    EmergencyContactListActive200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawData == null
          ...
          : deserialize<
              ...
              EmergencyContactListActive200Response
            >(rawData, 'EmergencyContactListActive200Response', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<EmergencyContactListActive200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [EmergencyContactListActive200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmergencyContactListActive200Response>>
  emergencyContactListActive({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/emergency-contacts/active';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
  ...
  emergencyContactToggleActive({
    ...
    final _path = r'/emergency-contacts/{id}/toggle'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  emergencyContactUpdate({
    ...
    try {
      _bodyData = jsonEncode(updateEmergencyContact);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmergencyGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmergencyGet200Response>> emergencyGet({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    EmergencyGet200Response? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<EmergencyGet200Response, EmergencyGet200Response>(
              rawData,
              'EmergencyGet200Response',
              growable: true,
            );
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<EmergencyGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<EmergencyListByOrder200Response>> emergencyListByOrder({
    ...
    EmergencyListByOrder200Response? _responseData;
  ...
  Future<Response<EmergencyTrigger200Response>> emergencyTrigger({
    ...
    EmergencyTrigger200Response? _responseData;
    ...
    return Response<EmergencyTrigger200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [EmergencyGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmergencyGet200Response>> emergencyUpdateStatus({
    required String id,
