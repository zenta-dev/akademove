...
_responseData = rawData == null ? null : deserialize<String, String>(rawData, 'String', growable: true);
  ...
  Future<Response<MerchantGet200Response>> merchantActivate({ 
    ...
    try {
      final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MerchantGet200Response, MerchantGet200Response>(rawData, 'MerchantGet200Response', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
...
_responseData = rawData == null ? null : deserialize<MerchantGet200Response, MerchantGet200Response>(rawData, 'MerchantGet200Response', growable: true);
  ...
  Future<Response<MerchantGet200Response>> merchantSetOrderTakingStatus({ 
    required String id,
    required MerchantSetOrderTakingStatusRequest merchantSetOrderTakingStatusRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/merchants/{id}/availability/order-taking'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
        _bodyData=jsonEncode(merchantSetOrderTakingStatusRequest);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
