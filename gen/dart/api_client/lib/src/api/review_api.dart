...
class ReviewApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ReviewCheckCanReview200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReviewCheckCanReview200Response>> reviewCheckCanReview({ 
    ...
    final _path = r'/reviews/can-review/{orderId}'.replaceAll('{' r'orderId' '}', orderId.toString());
    ...
    ReviewCheckCanReview200Response? _responseData;

    try {
      final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ReviewCheckCanReview200Response, ReviewCheckCanReview200Response>(rawData, 'ReviewCheckCanReview200Response', growable: true);
    ...
    return Response<ReviewCheckCanReview200Response>(
      data: _responseData,
  ...
  Future<Response<ReviewCreate200Response>> reviewCreate({ 
    ...
    ReviewCreate200Response? _responseData;

    try {
      final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ReviewCreate200Response, ReviewCreate200Response>(rawData, 'ReviewCreate200Response', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ReviewCreate200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ReviewCreate200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReviewCreate200Response>> reviewGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<ReviewCreate200Response, ReviewCreate200Response>(rawData, 'ReviewCreate200Response', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ReviewList200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReviewList200Response>> reviewGetByOrder({ 
    required String orderId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/reviews/order/{orderId}'.replaceAll('{' r'orderId' '}', orderId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ReviewList200Response? _responseData;

    try {
      final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ReviewList200Response, ReviewList200Response>(rawData, 'ReviewList200Response', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ReviewList200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ReviewList200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReviewList200Response>> reviewList({ 
    String? cursor,
    Object? limit,
    String? direction,
    Object? page,
...
_responseData = rawData == null ? null : deserialize<ReviewList200Response, ReviewList200Response>(rawData, 'ReviewList200Response', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BadgeRemove200Response>> reviewRemove({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
