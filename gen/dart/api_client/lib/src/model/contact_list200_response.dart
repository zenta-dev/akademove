...
class ContactList200Response {
  ...
  const ContactList200Response({required this.message, required this.data, this.pagination, this.totalPages});
  ...
  factory ContactList200Response.fromJson(Map<String, dynamic> json) => _$ContactList200ResponseFromJson(json);
