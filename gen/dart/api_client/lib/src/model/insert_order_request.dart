...
class InsertOrderRequest {
  /// Returns a new [InsertOrderRequest] instance.
  InsertOrderRequest({
  ...
  final InsertOrderRequestTypeEnum type;

  @JsonKey(name: r'status', required: true, includeIfNull: false)
  final InsertOrderRequestStatusEnum status;
  ...
  factory InsertOrderRequest.fromJson(Map<String, dynamic> json) =>
      _$InsertOrderRequestFromJson(json);
...
enum InsertOrderRequestTypeEnum {
  @JsonValue(r'ride')
  ride(r'ride'),
  ...
  const InsertOrderRequestTypeEnum(this.value);
...
enum InsertOrderRequestStatusEnum {
  ...
  const InsertOrderRequestStatusEnum(this.value);
