...
class CreateMerchantRequestTypeEnum extends EnumClass {
  ...
  static const CreateMerchantRequestTypeEnum merchant = _$createMerchantRequestTypeEnum_merchant;
  @BuiltValueEnumConst(wireName: r'tenant')
  static const CreateMerchantRequestTypeEnum tenant = _$createMerchantRequestTypeEnum_tenant;

  static Serializer<CreateMerchantRequestTypeEnum> get serializer => _$createMerchantRequestTypeEnumSerializer;

  const CreateMerchantRequestTypeEnum._(String name): super(name);

  static BuiltSet<CreateMerchantRequestTypeEnum> get values => _$createMerchantRequestTypeEnumValues;
  static CreateMerchantRequestTypeEnum valueOf(String name) => _$createMerchantRequestTypeEnumValueOf(name);
}
