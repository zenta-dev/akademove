...
part 'ws_place_order_envelope.g.dart';
...
class WSPlaceOrderEnvelope {
  /// Returns a new [WSPlaceOrderEnvelope] instance.
  const WSPlaceOrderEnvelope({
    required this.type,
    required this.from,
    required this.to,
  ...
  factory WSPlaceOrderEnvelope.fromJson(Map<String, dynamic> json) =>
      _$WSPlaceOrderEnvelopeFromJson(json);

  Map<String, dynamic> toJson() => _$WSPlaceOrderEnvelopeToJson(this);
