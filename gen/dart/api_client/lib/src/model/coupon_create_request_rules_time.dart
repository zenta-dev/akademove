...
class CouponCreateRequestRulesTime {
  ...
  final List<int>? allowedHours;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CouponCreateRequestRulesTime &&
  ...
  factory CouponCreateRequestRulesTime.fromJson(Map<String, dynamic> json) => _$CouponCreateRequestRulesTimeFromJson(json);
