...
class OrderCreateRequestMerchant {
  ...
  final DateTime? updatedAt;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is OrderCreateRequestMerchant &&
      other.id == id &&
      other.userId == userId &&
      other.name == name &&
      other.email == email &&
  ...
  factory OrderCreateRequestMerchant.fromJson(Map<String, dynamic> json) => _$OrderCreateRequestMerchantFromJson(json);
