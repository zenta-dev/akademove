...
class BannerListPublic200ResponseDataInner {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BannerListPublic200ResponseDataInner &&
    other.id == id &&
    other.title == title &&
  ...
  factory BannerListPublic200ResponseDataInner.fromJson(Map<String, dynamic> json) => _$BannerListPublic200ResponseDataInnerFromJson(json);

  Map<String, dynamic> toJson() => _$BannerListPublic200ResponseDataInnerToJson(this);
