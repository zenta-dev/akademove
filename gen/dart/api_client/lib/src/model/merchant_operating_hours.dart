...
class MerchantOperatingHours {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MerchantOperatingHours &&
    other.id == id &&
  ...
  factory MerchantOperatingHours.fromJson(Map<String, dynamic> json) => _$MerchantOperatingHoursFromJson(json);
