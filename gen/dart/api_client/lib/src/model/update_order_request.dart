...
class UpdateOrderRequestTypeEnum extends EnumClass {
  ...
  static const UpdateOrderRequestTypeEnum ride = _$updateOrderRequestTypeEnum_ride;
  @BuiltValueEnumConst(wireName: r'delivery')
  static const UpdateOrderRequestTypeEnum delivery = _$updateOrderRequestTypeEnum_delivery;
  @BuiltValueEnumConst(wireName: r'food')
  static const UpdateOrderRequestTypeEnum food = _$updateOrderRequestTypeEnum_food;

  static Serializer<UpdateOrderRequestTypeEnum> get serializer => _$updateOrderRequestTypeEnumSerializer;

  const UpdateOrderRequestTypeEnum._(String name): super(name);

  static BuiltSet<UpdateOrderRequestTypeEnum> get values => _$updateOrderRequestTypeEnumValues;
  static UpdateOrderRequestTypeEnum valueOf(String name) => _$updateOrderRequestTypeEnumValueOf(name);
}

class UpdateOrderRequestStatusEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'requested')
  static const UpdateOrderRequestStatusEnum requested = _$updateOrderRequestStatusEnum_requested;
  @BuiltValueEnumConst(wireName: r'matching')
  static const UpdateOrderRequestStatusEnum matching = _$updateOrderRequestStatusEnum_matching;
  @BuiltValueEnumConst(wireName: r'accepted')
  static const UpdateOrderRequestStatusEnum accepted = _$updateOrderRequestStatusEnum_accepted;
  @BuiltValueEnumConst(wireName: r'arriving')
  static const UpdateOrderRequestStatusEnum arriving = _$updateOrderRequestStatusEnum_arriving;
  @BuiltValueEnumConst(wireName: r'in_trip')
  static const UpdateOrderRequestStatusEnum inTrip = _$updateOrderRequestStatusEnum_inTrip;
  @BuiltValueEnumConst(wireName: r'completed')
  static const UpdateOrderRequestStatusEnum completed = _$updateOrderRequestStatusEnum_completed;
  @BuiltValueEnumConst(wireName: r'cancelled_by_user')
  static const UpdateOrderRequestStatusEnum cancelledByUser = _$updateOrderRequestStatusEnum_cancelledByUser;
  @BuiltValueEnumConst(wireName: r'cancelled_by_driver')
  static const UpdateOrderRequestStatusEnum cancelledByDriver = _$updateOrderRequestStatusEnum_cancelledByDriver;
  @BuiltValueEnumConst(wireName: r'cancelled_by_system')
  static const UpdateOrderRequestStatusEnum cancelledBySystem = _$updateOrderRequestStatusEnum_cancelledBySystem;

  static Serializer<UpdateOrderRequestStatusEnum> get serializer => _$updateOrderRequestStatusEnumSerializer;

  const UpdateOrderRequestStatusEnum._(String name): super(name);

  static BuiltSet<UpdateOrderRequestStatusEnum> get values => _$updateOrderRequestStatusEnumValues;
  static UpdateOrderRequestStatusEnum valueOf(String name) => _$updateOrderRequestStatusEnumValueOf(name);
}
