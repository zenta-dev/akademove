...
part 'insert_order_request_merchant.g.dart';
...
class InsertOrderRequestMerchant {
  /// Returns a new [InsertOrderRequestMerchant] instance.
  InsertOrderRequestMerchant({
    this.id,
  ...
  bool operator ==(Object other) =>
      ...
      other is InsertOrderRequestMerchant &&
          other.id == id &&
          other.userId == userId &&
          other.name == name &&
          other.email == email &&
  ...
  factory InsertOrderRequestMerchant.fromJson(Map<String, dynamic> json) =>
      _$InsertOrderRequestMerchantFromJson(json);

  Map<String, dynamic> toJson() => _$InsertOrderRequestMerchantToJson(this);
