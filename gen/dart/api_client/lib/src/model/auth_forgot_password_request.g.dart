...
class _$AuthForgotPasswordRequestCWProxyImpl implements _$AuthForgotPasswordRequestCWProxy {
  ...
  /// AuthForgotPasswordRequest(...).copyWith(id: 12, name: "My name")
  /// ```
  AuthForgotPasswordRequest call({Object? email = const $CopyWithPlaceholder()}) {
...
extension $AuthForgotPasswordRequestCopyWith on AuthForgotPasswordRequest {
  ...
  _$AuthForgotPasswordRequestCWProxy get copyWith => _$AuthForgotPasswordRequestCWProxyImpl(this);
}
...
AuthForgotPasswordRequest _$AuthForgotPasswordRequestFromJson(Map<String, dynamic> json) =>
    $checkedCreate('AuthForgotPasswordRequest', json, ($checkedConvert) {
      $checkKeys(json, requiredKeys: const ['email']);
      final val = AuthForgotPasswordRequest(email: $checkedConvert('email', (v) => v as String));
      return val;
    });

Map<String, dynamic> _$AuthForgotPasswordRequestToJson(AuthForgotPasswordRequest instance) => <String, dynamic>{
