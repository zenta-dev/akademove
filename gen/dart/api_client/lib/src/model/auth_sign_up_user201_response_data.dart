...
class AuthSignUpUser201ResponseData {
  ...
  final User user;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is AuthSignUpUser201ResponseData &&
      other.user == user;
  ...
  factory AuthSignUpUser201ResponseData.fromJson(Map<String, dynamic> json) => _$AuthSignUpUser201ResponseDataFromJson(json);
