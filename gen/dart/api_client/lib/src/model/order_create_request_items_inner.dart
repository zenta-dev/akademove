...
class OrderCreateRequestItemsInner {
  ...
  bool operator ==(Object other) =>
      ...
      other is OrderCreateRequestItemsInner &&
          other.id == id &&
          other.itemId == itemId &&
          other.total == total &&
          other.item == item;
  ...
  @override
  int get hashCode =>
      id.hashCode + itemId.hashCode + total.hashCode + item.hashCode;

  factory OrderCreateRequestItemsInner.fromJson(Map<String, dynamic> json) =>
      _$OrderCreateRequestItemsInnerFromJson(json);
