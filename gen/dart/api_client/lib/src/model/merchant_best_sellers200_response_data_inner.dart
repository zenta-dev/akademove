...
class MerchantBestSellers200ResponseDataInner {
  ...
  const MerchantBestSellers200ResponseDataInner({required this.menu, required this.merchant, required this.orderCount});
  ...
  factory MerchantBestSellers200ResponseDataInner.fromJson(Map<String, dynamic> json) =>
