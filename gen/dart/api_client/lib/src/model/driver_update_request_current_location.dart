...
class DriverUpdateRequestCurrentLocation {
  ...
  const DriverUpdateRequestCurrentLocation({
    required this.x,
    required this.y,
  });
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DriverUpdateRequestCurrentLocation &&
    other.x == x &&
    other.y == y;
  ...
  factory DriverUpdateRequestCurrentLocation.fromJson(Map<String, dynamic> json) => _$DriverUpdateRequestCurrentLocationFromJson(json);
