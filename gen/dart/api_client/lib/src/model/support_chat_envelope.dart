...
class SupportChatEnvelope {
  ...
  @override
  int get hashCode =>
      e.hashCode + a.hashCode + f.hashCode + t.hashCode + p.hashCode;

  factory SupportChatEnvelope.fromJson(Map<String, dynamic> json) =>
      _$SupportChatEnvelopeFromJson(json);
