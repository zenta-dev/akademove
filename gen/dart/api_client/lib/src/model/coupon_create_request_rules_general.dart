...
class CouponCreateRequestRulesGeneral {
  ...
  final num? maxDiscountAmount;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CouponCreateRequestRulesGeneral &&
      other.type == type &&
  ...
  factory CouponCreateRequestRulesGeneral.fromJson(Map<String, dynamic> json) => _$CouponCreateRequestRulesGeneralFromJson(json);

  Map<String, dynamic> toJson() => _$CouponCreateRequestRulesGeneralToJson(this);
