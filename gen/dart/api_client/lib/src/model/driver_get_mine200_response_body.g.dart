...
abstract class _$DriverGetMine200ResponseBodyCWProxy {
  ...
  /// ```
  DriverGetMine200ResponseBody call({String message, Driver data, PaginationResult? pagination, int? totalPages});
}
...
class _$DriverGetMine200ResponseBodyCWProxyImpl implements _$DriverGetMine200ResponseBodyCWProxy {
  const _$DriverGetMine200ResponseBodyCWProxyImpl(this._value);

  final DriverGetMine200ResponseBody _value;

  @override
  DriverGetMine200ResponseBody message(String message) => call(message: message);

  @override
  DriverGetMine200ResponseBody data(Driver data) => call(data: data);

  @override
  DriverGetMine200ResponseBody pagination(PaginationResult? pagination) => call(pagination: pagination);

  @override
  DriverGetMine200ResponseBody totalPages(int? totalPages) => call(totalPages: totalPages);
...
extension $DriverGetMine200ResponseBodyCopyWith on DriverGetMine200ResponseBody {
  ...
  _$DriverGetMine200ResponseBodyCWProxy get copyWith => _$DriverGetMine200ResponseBodyCWProxyImpl(this);
}
...
DriverGetMine200ResponseBody _$DriverGetMine200ResponseBodyFromJson(Map<String, dynamic> json) =>
    $checkedCreate('DriverGetMine200ResponseBody', json, ($checkedConvert) {
      $checkKeys(json, requiredKeys: const ['message', 'data']);
      final val = DriverGetMine200ResponseBody(
        message: $checkedConvert('message', (v) => v as String),
        data: $checkedConvert('data', (v) => Driver.fromJson(v as Map<String, dynamic>)),
...
Map<String, dynamic> _$DriverGetMine200ResponseBodyToJson(DriverGetMine200ResponseBody instance) => <String, dynamic>{
