...
class NotificationSaveToken200ResponseData {
  ...
  const NotificationSaveToken200ResponseData({
    required this.ok,
  });
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NotificationSaveToken200ResponseData &&
    other.ok == ok;
  ...
  factory NotificationSaveToken200ResponseData.fromJson(Map<String, dynamic> json) => _$NotificationSaveToken200ResponseDataFromJson(json);
