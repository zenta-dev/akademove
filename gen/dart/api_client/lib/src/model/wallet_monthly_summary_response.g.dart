...
abstract class _$WalletMonthlySummaryResponseCWProxy {
  ...
  /// ```
  WalletMonthlySummaryResponse call({String month, num totalIncome, num totalExpense, num net});
}
...
class _$WalletMonthlySummaryResponseCWProxyImpl implements _$WalletMonthlySummaryResponseCWProxy {
  ...
  @override
  WalletMonthlySummaryResponse totalIncome(num totalIncome) => call(totalIncome: totalIncome);

  @override
  WalletMonthlySummaryResponse totalExpense(num totalExpense) => call(totalExpense: totalExpense);
  ...
  WalletMonthlySummaryResponse call({
    ...
    return WalletMonthlySummaryResponse(
      month: month == const $CopyWithPlaceholder() || month == null
          ...
          : month as String,
      totalIncome: totalIncome == const $CopyWithPlaceholder() || totalIncome == null
          ? _value.totalIncome
          // ignore: cast_nullable_to_non_nullable
          : totalIncome as num,
      totalExpense: totalExpense == const $CopyWithPlaceholder() || totalExpense == null
          ? _value.totalExpense
          // ignore: cast_nullable_to_non_nullable
          : totalExpense as num,
...
extension $WalletMonthlySummaryResponseCopyWith on WalletMonthlySummaryResponse {
  ...
  _$WalletMonthlySummaryResponseCWProxy get copyWith => _$WalletMonthlySummaryResponseCWProxyImpl(this);
}
...
WalletMonthlySummaryResponse _$WalletMonthlySummaryResponseFromJson(Map<String, dynamic> json) =>
    $checkedCreate('WalletMonthlySummaryResponse', json, ($checkedConvert) {
      $checkKeys(json, requiredKeys: const ['month', 'totalIncome', 'totalExpense', 'net']);
...
Map<String, dynamic> _$WalletMonthlySummaryResponseToJson(WalletMonthlySummaryResponse instance) => <String, dynamic>{
