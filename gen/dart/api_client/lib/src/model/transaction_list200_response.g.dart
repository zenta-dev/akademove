...
class _$TransactionList200ResponseCWProxyImpl implements _$TransactionList200ResponseCWProxy {
  ...
  @override
  TransactionList200Response pagination(PaginationResult? pagination) => call(pagination: pagination);

  @override
  TransactionList200Response totalPages(int? totalPages) => call(totalPages: totalPages);
...
extension $TransactionList200ResponseCopyWith on TransactionList200Response {
  ...
  _$TransactionList200ResponseCWProxy get copyWith => _$TransactionList200ResponseCWProxyImpl(this);
}
...
TransactionList200Response _$TransactionList200ResponseFromJson(Map<String, dynamic> json) =>
    $checkedCreate('TransactionList200Response', json, ($checkedConvert) {
      ...
      final val = TransactionList200Response(
        ...
        data: $checkedConvert(
          'data',
          (v) => (v as List<dynamic>).map((e) => Transaction.fromJson(e as Map<String, dynamic>)).toList(),
        ),
...
Map<String, dynamic> _$TransactionList200ResponseToJson(TransactionList200Response instance) => <String, dynamic>{
