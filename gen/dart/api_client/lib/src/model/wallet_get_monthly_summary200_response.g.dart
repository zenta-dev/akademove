...
class _$WalletGetMonthlySummary200ResponseCWProxyImpl implements _$WalletGetMonthlySummary200ResponseCWProxy {
  const _$WalletGetMonthlySummary200ResponseCWProxyImpl(this._value);

  final WalletGetMonthlySummary200Response _value;

  @override
  WalletGetMonthlySummary200Response message(String message) => call(message: message);

  @override
  WalletGetMonthlySummary200Response data(WalletMonthlySummaryResponse data) => call(data: data);

  @override
  WalletGetMonthlySummary200Response pagination(PaginationResult? pagination) => call(pagination: pagination);

  @override
  WalletGetMonthlySummary200Response totalPages(int? totalPages) => call(totalPages: totalPages);
...
extension $WalletGetMonthlySummary200ResponseCopyWith on WalletGetMonthlySummary200Response {
  ...
  _$WalletGetMonthlySummary200ResponseCWProxy get copyWith => _$WalletGetMonthlySummary200ResponseCWProxyImpl(this);
}
...
WalletGetMonthlySummary200Response _$WalletGetMonthlySummary200ResponseFromJson(Map<String, dynamic> json) =>
    $checkedCreate('WalletGetMonthlySummary200Response', json, ($checkedConvert) {
      $checkKeys(json, requiredKeys: const ['message', 'data']);
      final val = WalletGetMonthlySummary200Response(
        message: $checkedConvert('message', (v) => v as String),
        data: $checkedConvert('data', (v) => WalletMonthlySummaryResponse.fromJson(v as Map<String, dynamic>)),
...
Map<String, dynamic> _$WalletGetMonthlySummary200ResponseToJson(WalletGetMonthlySummary200Response instance) =>
    <String, dynamic>{
