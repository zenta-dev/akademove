...
part 'insert_driver_schedule_request.g.dart';
...
class InsertDriverScheduleRequest {
  ...
  factory InsertDriverScheduleRequest.fromJson(Map<String, dynamic> json) =>
      _$InsertDriverScheduleRequestFromJson(json);

  Map<String, dynamic> toJson() => _$InsertDriverScheduleRequestToJson(this);
