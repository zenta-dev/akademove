...
abstract class _$OrderSummaryBreakdownCWProxy {
  ...
  /// ```
  OrderSummaryBreakdown call({num? distance, num? duration, num? perMinuteRate, num? weight, num? perKgRate});
}
...
class _$OrderSummaryBreakdownCWProxyImpl implements _$OrderSummaryBreakdownCWProxy {
  ...
  @override
  OrderSummaryBreakdown perMinuteRate(num? perMinuteRate) => call(perMinuteRate: perMinuteRate);
...
extension $OrderSummaryBreakdownCopyWith on OrderSummaryBreakdown {
  ...
  _$OrderSummaryBreakdownCWProxy get copyWith => _$OrderSummaryBreakdownCWProxyImpl(this);
}
...
OrderSummaryBreakdown _$OrderSummaryBreakdownFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$OrderSummaryBreakdownToJson(OrderSummaryBreakdown instance) => <String, dynamic>{
