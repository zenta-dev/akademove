...
class MerchantEnvelope {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MerchantEnvelope &&
    other.e == e &&
    other.a == a &&
    other.tg == tg &&
    other.f == f &&
  ...
  factory MerchantEnvelope.fromJson(Map<String, dynamic> json) => _$MerchantEnvelopeFromJson(json);
