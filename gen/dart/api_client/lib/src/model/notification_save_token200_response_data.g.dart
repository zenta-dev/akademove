...
class _$NotificationSaveToken200ResponseDataCWProxyImpl implements _$NotificationSaveToken200ResponseDataCWProxy {
  ...
  /// NotificationSaveToken200ResponseData(...).copyWith(id: 12, name: "My name")
  /// ```
  NotificationSaveToken200ResponseData call({Object? ok = const $CopyWithPlaceholder()}) {
...
extension $NotificationSaveToken200ResponseDataCopyWith on NotificationSaveToken200ResponseData {
  ...
  _$NotificationSaveToken200ResponseDataCWProxy get copyWith => _$NotificationSaveToken200ResponseDataCWProxyImpl(this);
}
...
NotificationSaveToken200ResponseData _$NotificationSaveToken200ResponseDataFromJson(Map<String, dynamic> json) =>
    $checkedCreate('NotificationSaveToken200ResponseData', json, ($checkedConvert) {
      $checkKeys(json, requiredKeys: const ['ok']);
      final val = NotificationSaveToken200ResponseData(ok: $checkedConvert('ok', (v) => v as bool));
      return val;
    });

Map<String, dynamic> _$NotificationSaveToken200ResponseDataToJson(NotificationSaveToken200ResponseData instance) =>
