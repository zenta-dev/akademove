...
class Broadcast {
  ...
  @JsonKey(defaultValue: 0,name: r'successCount', required: false, includeIfNull: false)
  final num? successCount;
  
  @JsonKey(defaultValue: 0,name: r'totalCount', required: false, includeIfNull: false)
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Broadcast &&
    other.id == id &&
    other.title == title &&
