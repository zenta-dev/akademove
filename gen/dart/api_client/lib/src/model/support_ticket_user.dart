...
class SupportTicketUser {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SupportTicketUser &&
    other.name == name &&
    other.image == image &&
    other.email == email;
  ...
  factory SupportTicketUser.fromJson(Map<String, dynamic> json) => _$SupportTicketUserFromJson(json);
