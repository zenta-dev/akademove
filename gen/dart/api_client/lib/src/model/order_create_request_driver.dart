...
class OrderCreateRequestDriver {
  ...
  final OrderCreateRequestUser? user;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is OrderCreateRequestDriver &&
      other.id == id &&
      other.userId == userId &&
  ...
  factory OrderCreateRequestDriver.fromJson(Map<String, dynamic> json) => _$OrderCreateRequestDriverFromJson(json);
