...
class NotificationMarkAsRead200ResponseData {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NotificationMarkAsRead200ResponseData &&
    other.id == id &&
    other.userId == userId &&
    other.title == title &&
    other.body == body &&
  ...
  factory NotificationMarkAsRead200ResponseData.fromJson(Map<String, dynamic> json) => _$NotificationMarkAsRead200ResponseDataFromJson(json);

  Map<String, dynamic> toJson() => _$NotificationMarkAsRead200ResponseDataToJson(this);
