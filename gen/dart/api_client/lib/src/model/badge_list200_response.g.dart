...
abstract class _$BadgeList200ResponseCWProxy {
  ...
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `BadgeList200Response(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
