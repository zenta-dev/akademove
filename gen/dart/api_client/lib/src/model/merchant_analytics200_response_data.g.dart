...
abstract class _$MerchantAnalytics200ResponseDataCWProxy {
  ...
  MerchantAnalytics200ResponseData revenueByDay(List<MerchantAnalytics200ResponseDataRevenueByDayInner> revenueByDay);
...
class _$MerchantAnalytics200ResponseDataCWProxyImpl implements _$MerchantAnalytics200ResponseDataCWProxy {
  const _$MerchantAnalytics200ResponseDataCWProxyImpl(this._value);

  final MerchantAnalytics200ResponseData _value;

  @override
  MerchantAnalytics200ResponseData totalOrders(num totalOrders) => call(totalOrders: totalOrders);

  @override
  MerchantAnalytics200ResponseData totalRevenue(num totalRevenue) => call(totalRevenue: totalRevenue);

  @override
  MerchantAnalytics200ResponseData totalCommission(num totalCommission) => call(totalCommission: totalCommission);

  @override
  MerchantAnalytics200ResponseData completedOrders(num completedOrders) => call(completedOrders: completedOrders);

  @override
  MerchantAnalytics200ResponseData cancelledOrders(num cancelledOrders) => call(cancelledOrders: cancelledOrders);
  ...
  MerchantAnalytics200ResponseData call({
    ...
    return MerchantAnalytics200ResponseData(
      ...
      totalRevenue: totalRevenue == const $CopyWithPlaceholder() || totalRevenue == null
          ...
          // ignore: cast_nullable_to_non_nullable
          : totalRevenue as num,
      totalCommission: totalCommission == const $CopyWithPlaceholder() || totalCommission == null
      ...
      averageOrderValue: averageOrderValue == const $CopyWithPlaceholder() || averageOrderValue == null
          ? _value.averageOrderValue
          // ignore: cast_nullable_to_non_nullable
          : averageOrderValue as num,
      topSellingItems: topSellingItems == const $CopyWithPlaceholder() || topSellingItems == null
          ? _value.topSellingItems
          // ignore: cast_nullable_to_non_nullable
          : topSellingItems as List<MerchantAnalytics200ResponseDataTopSellingItemsInner>,
      revenueByDay: revenueByDay == const $CopyWithPlaceholder() || revenueByDay == null
          ? _value.revenueByDay
          // ignore: cast_nullable_to_non_nullable
          : revenueByDay as List<MerchantAnalytics200ResponseDataRevenueByDayInner>,
    );
  }
}

extension $MerchantAnalytics200ResponseDataCopyWith on MerchantAnalytics200ResponseData {
  ...
  _$MerchantAnalytics200ResponseDataCWProxy get copyWith => _$MerchantAnalytics200ResponseDataCWProxyImpl(this);
}
...
MerchantAnalytics200ResponseData _$MerchantAnalytics200ResponseDataFromJson(Map<String, dynamic> json) =>
    $checkedCreate('MerchantAnalytics200ResponseData', json, ($checkedConvert) {
      $checkKeys(
        json,
        requiredKeys: const [
          'totalOrders',
      ...
      final val = MerchantAnalytics200ResponseData(
        ...
        topSellingItems: $checkedConvert(
          'topSellingItems',
          (v) => (v as List<dynamic>)
              .map((e) => MerchantAnalytics200ResponseDataTopSellingItemsInner.fromJson(e as Map<String, dynamic>))
              .toList(),
        ),
        revenueByDay: $checkedConvert(
          'revenueByDay',
          (v) => (v as List<dynamic>)
              .map((e) => MerchantAnalytics200ResponseDataRevenueByDayInner.fromJson(e as Map<String, dynamic>))
              .toList(),
        ),
      );
      return val;
...
Map<String, dynamic> _$MerchantAnalytics200ResponseDataToJson(MerchantAnalytics200ResponseData instance) =>
    <String, dynamic>{
