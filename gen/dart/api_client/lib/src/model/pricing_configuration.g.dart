...
class _$PricingConfigurationCWProxyImpl implements _$PricingConfigurationCWProxy {
  ...
  @override
  PricingConfiguration minimumFare(num minimumFare) => call(minimumFare: minimumFare);

  @override
  PricingConfiguration platformFeeRate(num platformFeeRate) => call(platformFeeRate: platformFeeRate);
...
extension $PricingConfigurationCopyWith on PricingConfiguration {
  ...
  _$PricingConfigurationCWProxy get copyWith => _$PricingConfigurationCWProxyImpl(this);
}
...
PricingConfiguration _$PricingConfigurationFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$PricingConfigurationToJson(PricingConfiguration instance) => <String, dynamic>{
