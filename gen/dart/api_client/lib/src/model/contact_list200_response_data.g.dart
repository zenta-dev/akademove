...
abstract class _$ContactList200ResponseDataCWProxy {
  ...
  ContactList200ResponseData pagination(ContactList200ResponseDataPagination? pagination);
  ...
  /// ```
  ContactList200ResponseData call({List<Contact> rows, ContactList200ResponseDataPagination? pagination});
}
...
class _$ContactList200ResponseDataCWProxyImpl implements _$ContactList200ResponseDataCWProxy {
...
extension $ContactList200ResponseDataCopyWith on ContactList200ResponseData {
  ...
  _$ContactList200ResponseDataCWProxy get copyWith => _$ContactList200ResponseDataCWProxyImpl(this);
}
...
ContactList200ResponseData _$ContactList200ResponseDataFromJson(Map<String, dynamic> json) =>
    $checkedCreate('ContactList200ResponseData', json, ($checkedConvert) {
      ...
      final val = ContactList200ResponseData(
        rows: $checkedConvert(
          'rows',
          (v) => (v as List<dynamic>).map((e) => Contact.fromJson(e as Map<String, dynamic>)).toList(),
        ),
        pagination: $checkedConvert(
          'pagination',
          (v) => v == null ? null : ContactList200ResponseDataPagination.fromJson(v as Map<String, dynamic>),
        ),
      );
      return val;
    });

Map<String, dynamic> _$ContactList200ResponseDataToJson(ContactList200ResponseData instance) => <String, dynamic>{
