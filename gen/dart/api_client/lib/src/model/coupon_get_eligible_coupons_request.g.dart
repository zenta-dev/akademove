...
abstract class _$CouponGetEligibleCouponsRequestCWProxy {
  ...
  /// ```
  CouponGetEligibleCouponsRequest call({OrderType serviceType, num totalAmount, String? merchantId});
}
...
class _$CouponGetEligibleCouponsRequestCWProxyImpl implements _$CouponGetEligibleCouponsRequestCWProxy {
  const _$CouponGetEligibleCouponsRequestCWProxyImpl(this._value);

  final CouponGetEligibleCouponsRequest _value;

  @override
  CouponGetEligibleCouponsRequest serviceType(OrderType serviceType) => call(serviceType: serviceType);

  @override
  CouponGetEligibleCouponsRequest totalAmount(num totalAmount) => call(totalAmount: totalAmount);

  @override
  CouponGetEligibleCouponsRequest merchantId(String? merchantId) => call(merchantId: merchantId);
  ...
  CouponGetEligibleCouponsRequest call({
    ...
    return CouponGetEligibleCouponsRequest(
      serviceType: serviceType == const $CopyWithPlaceholder() || serviceType == null
          ? _value.serviceType
          // ignore: cast_nullable_to_non_nullable
          : serviceType as OrderType,
      totalAmount: totalAmount == const $CopyWithPlaceholder() || totalAmount == null
          ? _value.totalAmount
          // ignore: cast_nullable_to_non_nullable
          : totalAmount as num,
...
extension $CouponGetEligibleCouponsRequestCopyWith on CouponGetEligibleCouponsRequest {
  ...
  _$CouponGetEligibleCouponsRequestCWProxy get copyWith => _$CouponGetEligibleCouponsRequestCWProxyImpl(this);
}
...
CouponGetEligibleCouponsRequest _$CouponGetEligibleCouponsRequestFromJson(Map<String, dynamic> json) =>
    $checkedCreate('CouponGetEligibleCouponsRequest', json, ($checkedConvert) {
      ...
      final val = CouponGetEligibleCouponsRequest(
        serviceType: $checkedConvert('serviceType', (v) => $enumDecode(_$OrderTypeEnumMap, v)),
...
Map<String, dynamic> _$CouponGetEligibleCouponsRequestToJson(CouponGetEligibleCouponsRequest instance) =>
    <String, dynamic>{
