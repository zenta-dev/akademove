...
class CommissionReportQuery {
  ...
  @JsonKey(defaultValue: CommissionReportPeriod.daily,name: r'period', required: false, includeIfNull: false)
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CommissionReportQuery &&
    other.period == period &&
  ...
  factory CommissionReportQuery.fromJson(Map<String, dynamic> json) => _$CommissionReportQueryFromJson(json);
