...
class DriverGetReview200ResponseData {
  ...
  final DriverGetReview200ResponseDataDriverLicenseStatusEnum driverLicenseStatus;
  
  @JsonKey(name: r'driverLicenseReason', required: true, includeIfNull: true)
  final String? driverLicenseReason;
  
  @JsonKey(name: r'vehicleRegistrationStatus', required: true, includeIfNull: false)
  final DriverGetReview200ResponseDataVehicleRegistrationStatusEnum vehicleRegistrationStatus;
  
  @JsonKey(name: r'vehicleRegistrationReason', required: true, includeIfNull: true)
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DriverGetReview200ResponseData &&
    other.id == id &&
  ...
  int get hashCode =>
      ...
      (vehicleRegistrationReason == null ? 0 : vehicleRegistrationReason.hashCode) +
  ...
  factory DriverGetReview200ResponseData.fromJson(Map<String, dynamic> json) => _$DriverGetReview200ResponseDataFromJson(json);
