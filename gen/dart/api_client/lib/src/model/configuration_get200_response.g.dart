...
abstract class _$ConfigurationGet200ResponseCWProxy {
  ...
  /// ```
  ConfigurationGet200Response call({String message, Configuration data, PaginationResult? pagination, int? totalPages});
}
...
class _$ConfigurationGet200ResponseCWProxyImpl implements _$ConfigurationGet200ResponseCWProxy {
  ...
  @override
  ConfigurationGet200Response pagination(PaginationResult? pagination) => call(pagination: pagination);

  @override
  ConfigurationGet200Response totalPages(int? totalPages) => call(totalPages: totalPages);
...
extension $ConfigurationGet200ResponseCopyWith on ConfigurationGet200Response {
  ...
  _$ConfigurationGet200ResponseCWProxy get copyWith => _$ConfigurationGet200ResponseCWProxyImpl(this);
}
...
ConfigurationGet200Response _$ConfigurationGet200ResponseFromJson(Map<String, dynamic> json) =>
    $checkedCreate('ConfigurationGet200Response', json, ($checkedConvert) {
      $checkKeys(json, requiredKeys: const ['message', 'data']);
      final val = ConfigurationGet200Response(
        message: $checkedConvert('message', (v) => v as String),
        data: $checkedConvert('data', (v) => Configuration.fromJson(v as Map<String, dynamic>)),
...
Map<String, dynamic> _$ConfigurationGet200ResponseToJson(ConfigurationGet200Response instance) => <String, dynamic>{
