...
class ConfigurationUpdateRequest {
  ...
  ConfigurationUpdateRequest({this.name, this.value, this.description});
  ...
  bool operator ==(Object other) =>
      ...
      other is ConfigurationUpdateRequest &&
          other.name == name &&
          other.value == value &&
  ...
  factory ConfigurationUpdateRequest.fromJson(Map<String, dynamic> json) =>
      _$ConfigurationUpdateRequestFromJson(json);
