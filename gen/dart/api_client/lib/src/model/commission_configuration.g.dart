...
class _$CommissionConfigurationCWProxyImpl implements _$CommissionConfigurationCWProxy {
  const _$CommissionConfigurationCWProxyImpl(this._value);

  final CommissionConfiguration _value;

  @override
  CommissionConfiguration rideCommissionRate(num rideCommissionRate) => call(rideCommissionRate: rideCommissionRate);
  ...
  @override
  CommissionConfiguration foodCommissionRate(num foodCommissionRate) => call(foodCommissionRate: foodCommissionRate);
  ...
  CommissionConfiguration call({
    ...
    return CommissionConfiguration(
      rideCommissionRate: rideCommissionRate == const $CopyWithPlaceholder() || rideCommissionRate == null
          ? _value.rideCommissionRate
          // ignore: cast_nullable_to_non_nullable
          : rideCommissionRate as num,
      deliveryCommissionRate: deliveryCommissionRate == const $CopyWithPlaceholder() || deliveryCommissionRate == null
          ? _value.deliveryCommissionRate
          // ignore: cast_nullable_to_non_nullable
          : deliveryCommissionRate as num,
      foodCommissionRate: foodCommissionRate == const $CopyWithPlaceholder() || foodCommissionRate == null
          ? _value.foodCommissionRate
          // ignore: cast_nullable_to_non_nullable
          : foodCommissionRate as num,
      merchantCommissionRate: merchantCommissionRate == const $CopyWithPlaceholder() || merchantCommissionRate == null
...
extension $CommissionConfigurationCopyWith on CommissionConfiguration {
  ...
  _$CommissionConfigurationCWProxy get copyWith => _$CommissionConfigurationCWProxyImpl(this);
}
...
CommissionConfiguration _$CommissionConfigurationFromJson(Map<String, dynamic> json) =>
    $checkedCreate('CommissionConfiguration', json, ($checkedConvert) {
      ...
      final val = CommissionConfiguration(
        ...
        deliveryCommissionRate: $checkedConvert('deliveryCommissionRate', (v) => v as num),
        foodCommissionRate: $checkedConvert('foodCommissionRate', (v) => v as num),
        merchantCommissionRate: $checkedConvert('merchantCommissionRate', (v) => v as num),
      );
      return val;
    });

Map<String, dynamic> _$CommissionConfigurationToJson(CommissionConfiguration instance) => <String, dynamic>{
