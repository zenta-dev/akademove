...
class BannerCreateRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BannerCreateRequest &&
    other.title == title &&
  ...
  factory BannerCreateRequest.fromJson(Map<String, dynamic> json) => _$BannerCreateRequestFromJson(json);
