...
class BannerUpdateRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BannerUpdateRequest &&
    other.title == title &&
  ...
  factory BannerUpdateRequest.fromJson(Map<String, dynamic> json) => _$BannerUpdateRequestFromJson(json);
