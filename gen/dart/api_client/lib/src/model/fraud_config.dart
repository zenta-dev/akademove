...
class FraudConfig {
  ...
  @JsonKey(
    defaultValue: 3,
    name: r'duplicateIpMaxRegistrations',
    required: false,
    includeIfNull: false,
  )
  ...
  @JsonKey(
    defaultValue: 0.85,
    name: r'nameSimilarityThreshold',
    required: false,
    includeIfNull: false,
  )
