...
part 'insert_report_request.g.dart';
...
class InsertReportRequest {
  /// Returns a new [InsertReportRequest] instance.
  InsertReportRequest({
    this.orderId,
  ...
  final InsertReportRequestCategoryEnum category;
  ...
  final InsertReportRequestStatusEnum status;
  ...
  factory InsertReportRequest.fromJson(Map<String, dynamic> json) =>
      _$InsertReportRequestFromJson(json);

  Map<String, dynamic> toJson() => _$InsertReportRequestToJson(this);
...
enum InsertReportRequestCategoryEnum {
  ...
  const InsertReportRequestCategoryEnum(this.value);
...
enum InsertReportRequestStatusEnum {
  @JsonValue(r'pending')
  pending(r'pending'),
  ...
  const InsertReportRequestStatusEnum(this.value);
