...
abstract class _$NotificationSubscribeToTopic200ResponseDataCWProxy {
  ...
  /// This function **does support** nullification of nullable fields. All `null` values passed to `non-nullable` fields will be ignored. You can also use `NotificationSubscribeToTopic200ResponseData(...).copyWith.fieldName(...)` to override fields one at a time with nullification support.
  ///
  /// Usage
  /// ```dart
...
/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOfNotificationSubscribeToTopic200ResponseData.copyWith(...)`. Additionally contains functions for specific fields e.g. `instanceOfNotificationSubscribeToTopic200ResponseData.copyWith.fieldName(...)`
  ...
  NotificationSubscribeToTopic200ResponseData call({
    ...
    return NotificationSubscribeToTopic200ResponseData(
      successCount: successCount == const $CopyWithPlaceholder()
          ...
          : successCount as num,
      failureCount: failureCount == const $CopyWithPlaceholder()
          ? _value.failureCount
          // ignore: cast_nullable_to_non_nullable
          : failureCount as num,
...
extension $NotificationSubscribeToTopic200ResponseDataCopyWith
  ...
  /// Returns a callable class that can be used as follows: `instanceOfNotificationSubscribeToTopic200ResponseData.copyWith(...)` or like so:`instanceOfNotificationSubscribeToTopic200ResponseData.copyWith.fieldName(...)`.
