...
class UpdateScheduleRequest {
  /// Returns a new [UpdateScheduleRequest] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is UpdateScheduleRequest &&
...
enum UpdateScheduleRequestDayOfWeekEnum {
  @JsonValue(r'sunday')
  sunday(r'sunday'),
  @JsonValue(r'monday')
  monday(r'monday'),
  ...
  const UpdateScheduleRequestDayOfWeekEnum(this.value);
