...
class TopUpRequest {
  ...
  const TopUpRequest({required this.amount, required this.provider, required this.method});
  ...
  bool operator ==(Object other) =>
      ...
      other is TopUpRequest && other.amount == amount && other.provider == provider && other.method == method;

  @override
  int get hashCode => amount.hashCode + provider.hashCode + method.hashCode;
