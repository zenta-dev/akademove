...
@BuiltValue()
abstract class RefreshTokenPostRequest implements Built<RefreshTokenPostRequest, RefreshTokenPostRequestBuilder> {
  ...
  factory RefreshTokenPostRequest([void updates(RefreshTokenPostRequestBuilder b)]) = _$RefreshTokenPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RefreshTokenPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RefreshTokenPostRequest> get serializer => _$RefreshTokenPostRequestSerializer();
}

class _$RefreshTokenPostRequestSerializer implements PrimitiveSerializer<RefreshTokenPostRequest> {
  @override
  final Iterable<Type> types = const [RefreshTokenPostRequest, _$RefreshTokenPostRequest];
