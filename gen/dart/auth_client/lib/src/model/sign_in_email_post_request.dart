...
/// * [rememberMe] 
@BuiltValue()
abstract class SignInEmailPostRequest implements Built<SignInEmailPostRequest, SignInEmailPostRequestBuilder> {
  /// Email of the user
  ...
  factory SignInEmailPostRequest([void updates(SignInEmailPostRequestBuilder b)]) = _$SignInEmailPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SignInEmailPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SignInEmailPostRequest> get serializer => _$SignInEmailPostRequestSerializer();
}

class _$SignInEmailPostRequestSerializer implements PrimitiveSerializer<SignInEmailPostRequest> {
  @override
  final Iterable<Type> types = const [SignInEmailPostRequest, _$SignInEmailPostRequest];
