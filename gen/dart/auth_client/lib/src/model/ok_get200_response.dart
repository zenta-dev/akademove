...
@BuiltValue()
abstract class OkGet200Response implements Built<OkGet200Response, OkGet200ResponseBuilder> {
  ...
  factory OkGet200Response([void updates(OkGet200ResponseBuilder b)]) = _$OkGet200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OkGet200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OkGet200Response> get serializer => _$OkGet200ResponseSerializer();
}

class _$OkGet200ResponseSerializer implements PrimitiveSerializer<OkGet200Response> {
  @override
