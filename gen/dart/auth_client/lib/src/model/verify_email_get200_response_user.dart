...
@BuiltValue()
abstract class VerifyEmailGet200ResponseUser implements Built<VerifyEmailGet200ResponseUser, VerifyEmailGet200ResponseUserBuilder> {
  /// User ID
  ...
  factory VerifyEmailGet200ResponseUser([void updates(VerifyEmailGet200ResponseUserBuilder b)]) = _$VerifyEmailGet200ResponseUser;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(VerifyEmailGet200ResponseUserBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<VerifyEmailGet200ResponseUser> get serializer => _$VerifyEmailGet200ResponseUserSerializer();
}

class _$VerifyEmailGet200ResponseUserSerializer implements PrimitiveSerializer<VerifyEmailGet200ResponseUser> {
  @override
  final Iterable<Type> types = const [VerifyEmailGet200ResponseUser, _$VerifyEmailGet200ResponseUser];
