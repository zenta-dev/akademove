...
@BuiltValue()
abstract class ChangeEmailPostRequest implements Built<ChangeEmailPostRequest, ChangeEmailPostRequestBuilder> {
  ...
  factory ChangeEmailPostRequest([void updates(ChangeEmailPostRequestBuilder b)]) = _$ChangeEmailPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ChangeEmailPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ChangeEmailPostRequest> get serializer => _$ChangeEmailPostRequestSerializer();
}

class _$ChangeEmailPostRequestSerializer implements PrimitiveSerializer<ChangeEmailPostRequest> {
  @override
  final Iterable<Type> types = const [ChangeEmailPostRequest, _$ChangeEmailPostRequest];
