...
@BuiltValue()
abstract class SendVerificationEmailPostRequest implements Built<SendVerificationEmailPostRequest, SendVerificationEmailPostRequestBuilder> {
  ...
  factory SendVerificationEmailPostRequest([void updates(SendVerificationEmailPostRequestBuilder b)]) = _$SendVerificationEmailPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SendVerificationEmailPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SendVerificationEmailPostRequest> get serializer => _$SendVerificationEmailPostRequestSerializer();
}

class _$SendVerificationEmailPostRequestSerializer implements PrimitiveSerializer<SendVerificationEmailPostRequest> {
  @override
  final Iterable<Type> types = const [SendVerificationEmailPostRequest, _$SendVerificationEmailPostRequest];
